...
- **2026-05-02:** Initial publication, with same-day revisions following an independent senior policy reviewer audit. Canonical contact email moved to `info@clawdemy.org`. ePrivacy exemption framing aligned with EDPB guidance on strictly-necessary cookies. Consent-withdrawal paragraph added to the deletion instructions. Forward-looking commitment ("we commit to updating before changing, not after") added.
