...
**Last updated: July 13, 2026.** [View change history](https://github.com/clawless-io/clawdemy/commits/main/src/content/docs/legal/cookies.mdx).
...
- **2026-07-13:** Disclosed the cookieless Cloudflare Web Analytics visit counter under "What we don't run" and "Future changes." The counter sets no cookies; the only cookie on the site remains the per-lesson functional star cookie.
