---
title: "Cheatsheet: The chain rule"
description: One-page reference. The chain rule, the rates-multiply intuition, the evaluated-at gotcha, worked compositions, and the backpropagation connection.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
