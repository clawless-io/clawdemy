---
title: "The derivative as a rate at an instant"
description: "A derivative should be the rate of change at a single instant, but nothing changes in an instant. Resolve the paradox with the limit of rise over run."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
