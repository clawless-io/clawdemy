---
title: "Product rule: cheatsheet"
description: "A one-page reference: the product rule, its growing-rectangle derivation, why it has two terms (not the product of the derivatives), and worked examples."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
