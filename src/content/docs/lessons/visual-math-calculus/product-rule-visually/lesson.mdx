---
title: "The product rule, via changing rectangles"
description: "Multiplying two functions: the natural guess (multiply the derivatives) is wrong. The product rule has two terms, and a growing rectangle shows exactly why."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
