---
title: "The product rule, in brief"
description: "An overview of the product rule: why multiplying two derivatives is wrong, how a growing rectangle gives its two terms, plus the examples you will work."
