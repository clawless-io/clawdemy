---
title: "Why e is special: its own derivative"
description: "e is not about its digits (2.718); it is the one base whose exponential is its own derivative, the property behind growth, decay, softmax, and the sigmoid."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
