...
{/* DIAGRAM PLACEHOLDER: graphs of 2^x, e^x, 3^x with their tangent slopes at a point, showing the slope/value ratio is below 1 for base 2, above 1 for base 3, and exactly 1 for base e */}
