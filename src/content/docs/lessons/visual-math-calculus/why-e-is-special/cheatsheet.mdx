---
title: "Why e is special: cheatsheet"
description: "Quick reference for e: the self-derivative property, the multiplier table, the chain-rule combo e^(kx), and why e drives softmax and the sigmoid."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
