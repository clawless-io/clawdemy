---
title: "Cheatsheet: Higher-order derivatives"
description: One-page reference. Higher derivatives and notation, the physics and concavity interpretations, the second-derivative test, and worked examples.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
