...
description: "A derivative is a function you can differentiate again. The second derivative measures how the slope changes: acceleration, curvature, and max from min."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
