...
{/* DIAGRAM PLACEHOLDER: three curve segments, one concave up (f''>0, smiling), one concave down (f''<0, frowning), and one passing through an inflection point where the curvature flips */}
