...
description: "Derive the derivatives of sine and cosine from one picture: a point circling the unit circle at unit speed, so both fall out with no memorizing."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
