---
title: "Cheatsheet: Trig derivatives from geometry"
description: One-page reference. The two trig derivatives, the unit-circle derivation, sanity checks, small-angle approximation, the oscillation equation, and why radians.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
