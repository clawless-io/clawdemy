---
title: "The essence of calculus, the area of a circle"
description: "Rederive the area of a circle from scratch and meet all of calculus in miniature: the two pillars, rates and accumulation, and the fact that they are inverses."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
