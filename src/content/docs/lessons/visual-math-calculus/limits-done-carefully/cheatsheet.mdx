---
title: "Limits and L'Hopital's rule: cheatsheet"
description: "One-page reference to the limit concept, epsilon-delta definition, indeterminate forms, L'Hopital's rule, and worked examples."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
