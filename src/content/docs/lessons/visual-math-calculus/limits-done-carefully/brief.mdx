...
description: "Lesson 9 of Track 8 (Visual Math: Calculus), closing Phase 2. Every derivative in this track has secretly been a limit, the value the rise-over-run ratio approaches as the interval shrinks. This lesson examines the limit itself: what 'approaches' really means, made precise by the epsilon-delta idea (for any demanded precision, an input window exists), and how L'Hopital's rule rescues the awkward 0/0 and infinity/infinity forms the rate definition keeps producing. It works several limits (sin x / x = 1, (e^x - 1)/x = 1, a twice-applied case = 1/2, (ln x)/x = 0), shows why the rule works (leading first-order behavior), and bundles three short source chapters into one."
