---
title: "Why area equals slope: cheatsheet"
description: "Quick reference for why area equals slope: the area function, the sliver move giving A'(x)=f(x), the fundamental theorem, and three worked examples."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
