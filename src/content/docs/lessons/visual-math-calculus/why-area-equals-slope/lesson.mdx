...
description: "One sliver of area proves the fundamental theorem of calculus: the derivative of accumulated area is the original curve, so integration undoes differentiation."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
