...
description: "Find the slope of a relation you cannot solve for y, like the circle x^2+y^2=25, using implicit differentiation, plus related rates as the time twin."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
