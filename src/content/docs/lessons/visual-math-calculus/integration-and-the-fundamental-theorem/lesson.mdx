...
description: "Make accumulation precise: define the integral as a limit of thin rectangles (Riemann sums) and meet the fundamental theorem linking it to differentiation."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
