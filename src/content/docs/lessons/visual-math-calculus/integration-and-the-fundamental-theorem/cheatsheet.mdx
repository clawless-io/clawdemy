---
title: "Integration and the FTC: cheatsheet"
description: "One-page reference: the integral as a Riemann-sum limit, the fundamental theorem, antiderivatives as reversed derivative rules, and definite vs indefinite."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
