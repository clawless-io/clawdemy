...
description: "Derive the power rule, d/dt(t^n) = n*t^(n-1), from the geometry of growing squares and cubes, then differentiate any polynomial without binomial expansion."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
