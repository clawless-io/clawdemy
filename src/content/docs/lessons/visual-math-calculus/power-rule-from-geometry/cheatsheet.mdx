---
title: "The power rule: cheatsheet"
description: "Reference: the power rule, its geometry (growing squares and cubes), negative and fractional powers, constant-multiple and sum rules, and a worked polynomial."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
