---
title: "Taylor series: approximating with polynomials"
description: "Taylor series rebuilds a function near a point from its derivatives, making sine and the exponential easy polynomials and the math machine learning runs on."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
