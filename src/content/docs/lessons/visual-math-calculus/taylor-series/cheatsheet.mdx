---
title: "Cheatsheet: Taylor series"
description: One-page reference. The Taylor expansion, why the factorials, the canonical series for e^x/sin/cos, the rigorous small-angle and L'Hopital connections, and the ML payoff. Bundles two source chapters.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
