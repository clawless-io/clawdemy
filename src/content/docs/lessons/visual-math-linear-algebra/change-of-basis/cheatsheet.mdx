---
title: "Change of basis: cheatsheet"
description: "Change of basis quick reference: coordinates as relative, the basis matrix and its inverse, translating both ways, transformation sandwich, worked examples."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
