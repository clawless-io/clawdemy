...
description: "A vector's coordinates describe it relative to a chosen basis, not absolutely. Translate them between bases and re-express a transformation in a new basis."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
