---
title: "Cheatsheet: Deriving the 3D cross product"
description: "One-page reference. The 3D cross product's three properties, the duality derivation, the formula as a cofactor expansion, worked examples, and the perpendicularity check."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
