---
title: "Cheatsheet: The determinant"
description: "One-page reference. The determinant as signed area/volume scaling, reading it off the unit square, the ad-bc formula, special values, worked examples, and the product rule."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
