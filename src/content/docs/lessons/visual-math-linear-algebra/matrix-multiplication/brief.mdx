---
title: "Matrix multiplication: brief"
description: "Overview of the matrix multiplication lesson: composition of transformations, computing products column by column, prerequisites, time, and outcomes."
