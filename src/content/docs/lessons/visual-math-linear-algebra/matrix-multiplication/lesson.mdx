...
description: "Matrix multiplication is not an arbitrary rule; it means composition, doing one transformation then another. See why order matters and grouping does not."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
