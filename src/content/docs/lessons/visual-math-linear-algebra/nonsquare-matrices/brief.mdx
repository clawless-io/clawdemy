---
title: "Matrices between dimensions"
description: "Lesson 8 of Track 4 (Visual Math: Linear Algebra). Every matrix so far has been square, taking a space back to a space of the same size. Drop that assumption. A rectangular matrix moves between dimensions, embedding a small space into a bigger one or projecting a big space down into a smaller one, and the rules you already know (columns, rank, null space) still tell the whole story."
