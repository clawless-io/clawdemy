...
description: "A rectangular matrix maps between dimensions, embedding a small space into a bigger one or projecting a big space down to a smaller one, with the same rules."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
