---
title: "Cheatsheet: Matrices between dimensions"
description: "One-page reference. Reading a rectangular matrix's shape, embedding vs projecting, rank, where column space and null space live, rank-nullity, and worked examples."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
