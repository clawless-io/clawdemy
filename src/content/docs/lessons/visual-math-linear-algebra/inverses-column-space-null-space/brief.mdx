---
title: "Matrix inverse and null space: brief"
description: "Orientation to inverses, column space, and null space: what you will learn, prerequisites, and the three equivalent tests for whether a matrix is invertible."
