---
title: "Cheatsheet: Undoing a transformation"
description: "One-page reference. The inverse, the invertibility condition, column space, rank, null space, rank-nullity conservation, and the three equivalent invertibility tests."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
