...
That is just *M* times *v* equals *b*, where *M* is the coefficient matrix, *v* the vector with components *x* and *y* is the unknown, and *b* the vector 3, 7 is the target. Solving the system means finding the input vector that the transformation *M* sends to the point 3, 7. Every linear system is the question "which vector lands here after this transformation," and that reframing is what makes the rest of the lesson useful.
