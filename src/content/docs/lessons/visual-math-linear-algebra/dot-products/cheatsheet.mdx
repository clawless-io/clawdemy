---
title: "Dot products: cheatsheet"
description: "Quick reference for the dot product: both formulas, the sign cases, projection, duality, worked examples, and the AI connections."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
