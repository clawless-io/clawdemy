...
description: "The dot product turns two vectors into one number, with two formulas (coordinates and angles) that agree, and how AI uses it to compare vectors in attention."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
