...
description: "With two vectors and only adding and scaling, which points can you reach? That set is the span, leading to basis, linear independence, and dimension."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
