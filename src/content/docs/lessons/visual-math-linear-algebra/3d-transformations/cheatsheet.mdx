---
title: "Cheatsheet: Stepping up to 3D"
description: "One-page reference. 3D linear transformations, the three basis vectors, the 3x3 matrix, the matrix-vector product, worked rotations and scaling, and the unit cube."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
