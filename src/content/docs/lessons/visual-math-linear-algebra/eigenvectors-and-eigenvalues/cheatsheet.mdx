---
title: "Cheatsheet: Eigenvectors and eigenvalues"
description: "One-page reference. The eigenvector equation, the characteristic equation, finding eigenvectors, the diagonal basis, worked examples, and the AI connections."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
