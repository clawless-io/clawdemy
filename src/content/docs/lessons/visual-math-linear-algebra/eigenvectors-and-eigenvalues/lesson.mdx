---
title: "The stubborn vectors: eigenvectors, eigenvalues"
description: "Most vectors get knocked off their line when a transformation moves the plane; eigenvectors stay on theirs and only scale. The scale factor is the eigenvalue."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
