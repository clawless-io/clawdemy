---
title: "Linear transformations: cheatsheet"
description: "One-page reference on linear transformations: what makes one linear, the basis-vector trick, matrix-as-columns, worked examples, and unit-square sketching."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
