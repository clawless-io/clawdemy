...
description: "A matrix is a record of where the two basis vectors land, the one idea that lets you sketch what any 2x2 matrix does to space without computing points."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
