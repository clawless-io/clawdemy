...
description: "A vector is an arrow in physics, a list of numbers in code, and an abstract object in math. Connect the three views and the two operations that define it."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
