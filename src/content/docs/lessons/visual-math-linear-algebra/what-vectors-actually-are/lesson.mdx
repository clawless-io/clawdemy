...
import LaVectorAsArrow from '../../../../../components/illustrations/t4/LaVectorAsArrow.astro';
import LaTipToTailAddition from '../../../../../components/illustrations/t4/LaTipToTailAddition.astro';
import LaScalarMultiplication from '../../../../../components/illustrations/t4/LaScalarMultiplication.astro';


<ReadAlongDim
  src="https://audio.clawdemy.org/lessons/what-vectors-actually-are-lesson.mp3"
  slug="what-vectors-actually-are"
