---
title: "What vectors are: cheatsheet"
description: "Vector quick reference: the three views, the two defining operations, notation, worked addition and scaling, pitfalls, and precise vocabulary."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
