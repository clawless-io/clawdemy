---
title: "Cheatsheet: Cramer's rule"
description: "One-page reference. The area-ratio derivation, the column-replacement formula, the invertibility requirement, and worked examples."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
