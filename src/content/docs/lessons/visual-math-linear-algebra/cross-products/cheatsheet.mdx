---
title: "Cross products: cheatsheet"
description: "One-page reference: the 2D cross product, signed area and orientation, the determinant connection, anti-commutativity, and worked examples."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
