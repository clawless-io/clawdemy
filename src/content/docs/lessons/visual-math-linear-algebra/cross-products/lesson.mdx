...
description: "The cross product measures how much two vectors spread apart: the signed area they span, which in 2D is exactly the determinant you already know."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
