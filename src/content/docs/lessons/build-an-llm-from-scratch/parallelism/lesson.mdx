...
description: "One GPU is rarely enough. The three classic schemes for splitting an LLM training run (data, tensor, pipeline) plus the modern sharded FSDP/ZeRO variant."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
