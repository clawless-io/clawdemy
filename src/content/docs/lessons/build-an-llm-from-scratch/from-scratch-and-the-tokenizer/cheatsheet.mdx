---
title: "Cheatsheet: What \"from scratch\" means, and the tokenizer"
description: One-page reference. The from-scratch stack, the efficiency frame, why subword, and the byte-level BPE procedure.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
