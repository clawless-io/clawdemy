---
title: "From scratch, and the tokenizer"
description: "What building an LLM from scratch involves end to end, why efficiency is the through-line, and the tokenizer, the first component, built with byte-level BPE."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
