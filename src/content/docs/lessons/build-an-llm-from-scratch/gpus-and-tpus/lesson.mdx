---
title: "How models run on hardware, GPUs and TPUs"
description: "How a GPU runs an LLM's math (SIMT, tensor cores), the memory hierarchy that decides whether compute stays fed, and how a TPU's systolic array differs."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
