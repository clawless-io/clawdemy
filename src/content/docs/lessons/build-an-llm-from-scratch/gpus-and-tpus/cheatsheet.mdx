---
title: "Cheatsheet: How models run on hardware"
description: One-page reference. GPU execution model, tensor cores, memory hierarchy, TPUs, and a diagnostic checklist.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
