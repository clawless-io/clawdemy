...
description: "Overview of what makes LLM inference expensive: the prefill/decode split, the KV cache, and the batching and quantization techniques, with prerequisites."
