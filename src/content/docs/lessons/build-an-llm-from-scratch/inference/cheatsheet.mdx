---
title: "Cheatsheet: Inference"
description: One-page reference. Prefill vs decode, the KV cache, and the five techniques (batching, paged attention, speculative decoding, quantization, GQA).
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
