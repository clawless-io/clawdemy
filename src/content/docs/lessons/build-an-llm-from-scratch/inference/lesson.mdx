...
description: "How serving an LLM becomes a memory-bandwidth problem in decode, plus the prefill/decode split, the KV cache, and the techniques that make decode efficient."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
