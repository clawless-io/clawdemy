---
title: "Counting the cost: FLOPs and memory"
description: "Estimate a model's training cost before you spend it: FLOPs and the 6ND rule, the 16N memory estimate, arithmetic intensity, and reading tensors with einops."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
