...
- **Kaplan to Chinchilla.** Kaplan (2020) recommended big-model-moderate-data (GPT-3). Chinchilla (2022) found `N*` and `D*` both scale as `compute^0.5`; rule of thumb `D* ~= 20 * N*`. Smaller model on more data, at the same compute, wins.
