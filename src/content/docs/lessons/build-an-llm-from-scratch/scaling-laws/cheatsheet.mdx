---
title: "Scaling laws: cheatsheet"
description: "Quick-reference card for scaling laws: power-law form, Kaplan vs Chinchilla, the 20 tokens-per-parameter rule, the 6ND budget calculation, and over-training."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
