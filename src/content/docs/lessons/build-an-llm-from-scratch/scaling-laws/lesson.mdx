...
description: "Scaling laws turn a fixed compute budget into optimal model size and data: the power-law form, the Kaplan to Chinchilla shift, and the inference-cost twist."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
