---
title: "Lesson: Data, part 2, filtering, deduplication, mixing, synthetic"
description: The later stages of the funnel from lesson 11. Heuristic and classifier filtering, exact and near-duplicate deduplication, mixing weights tuned with small-scale fits, and the increasingly important role of synthetic data, all taught as data engineering rather than policy.
sidebar:
  order: 2
  label: Lesson
artifact: lesson
