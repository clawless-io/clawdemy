---
title: "Cheatsheet: Data filtering, deduplication, mixing, synthetic"
description: One-page reference. Filtering layers, dedup levels, mixing strategies, synthetic-data categories.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
