---
title: "Data, part 2, filtering, deduplication, mixing, synthetic"
description: "Lesson 12 of Track 15. The later stages of the funnel from lesson 11: heuristic and classifier filtering, exact / near-duplicate / substring deduplication, mixing weights (increasingly learned rather than hand-tuned), and the fast-growing category of synthetic data. Taught technical-not-legal throughout: legal and policy debates about training data are out of scope here."
