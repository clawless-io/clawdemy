---
title: "Lesson: Data, part 1, sources and datasets"
description: Where the trillions of training tokens actually come from. Major data sources (web crawls, code, books, wikis, social text), the open pretraining datasets (The Pile, RedPajama, FineWeb), the scale-and-shrink between raw crawl and final corpus, and how mixing different domains shapes capability.
sidebar:
  order: 2
  label: Lesson
artifact: lesson
...
- **RefinedWeb** (Together, 2023). An earlier, cleaner open web dataset; influential for filtering recipes.
