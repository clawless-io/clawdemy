---
title: "Cheatsheet: Writing fast kernels"
description: One-page reference. Kernels, fusion, Triton vs XLA, FlashAttention, and a diagnostic for memory-bound chains.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
