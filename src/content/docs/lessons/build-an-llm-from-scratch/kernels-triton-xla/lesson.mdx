...
description: "How to make GPU operations fast: what a kernel is, why fusing ops is the biggest lever, and two paths (Triton and XLA), with FlashAttention as example."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
