---
title: "The Transformer architecture: cheatsheet"
description: "One-page reference for the decoder-only skeleton, the converged design choices, the sizing hyperparameters, and the parameter-count formula."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
