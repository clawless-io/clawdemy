---
title: "The Transformer architecture and hyperparameters"
description: "The decoder-only Transformer skeleton, the design choices modern LLMs converged on (pre-norm, RMSNorm, SwiGLU, RoPE), and the sizing hyperparameters."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
