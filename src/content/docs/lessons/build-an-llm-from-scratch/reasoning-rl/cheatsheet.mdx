---
title: "Reasoning and RLVR: cheatsheet"
description: "One-page reference for RLVR: the training loop, GRPO, RL as a systems problem, self-improvement loops, and the track-wide synthesis map."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
