---
title: "Reasoning and RLVR, in brief"
description: "Learning outcomes, prerequisites, and scope for the reasoning and RLVR lesson: the RLVR loop, GRPO, and how it caps the build-an-LLM pipeline."
