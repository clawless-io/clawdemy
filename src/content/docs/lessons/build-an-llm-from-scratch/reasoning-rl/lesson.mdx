---
title: "Reasoning: RL with verifiable rewards"
description: "How reasoning models learn to think step by step via reinforcement learning with verifiable rewards (RLVR), why it is mostly a systems problem at scale."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
