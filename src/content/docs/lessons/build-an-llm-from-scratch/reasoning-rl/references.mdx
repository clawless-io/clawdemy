...
• Stanford CS336, "Language Modeling from Scratch", Lectures 16 and 17:
    Post-training RLVR, Alignment RL (systems)
  ...
  Required attribution: "Based on the structure of Stanford CS336,
    ...
    not endorse it."
This lesson mirrors the structure of Lectures 16 and 17 (collapsed per the
Phase 0 mirror) and serves as the track capstone. Clawdemy's lessons are
original prose that follows the pedagogical arc of the course. Because the
...
- **[Stanford CS336, Lectures 16 and 17: Post-training RLVR and Alignment RL](https://www.youtube.com/playlist?list=PLoROMvodv4rMqXOcazWaTUHhq-yembLCV)** by Hashimoto and Liang. The two lectures this lesson collapses, with the GRPO mechanics and the RL-as-systems engineering in more depth.
...
- **["Group Robust Preference Optimization" / GRPO references in TRL](https://huggingface.co/docs/trl/main/en/grpo_trainer)**. The TRL documentation for GRPO. The reference for the loss and the loop, the fastest way to see the algorithm in code alongside SFTTrainer and DPOTrainer.
