---
title: "Evaluation, measuring a language model"
description: "How to measure whether a language model can do useful things: the standard benchmark formats, the four ways evaluation is hard, and the stack teams use."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
