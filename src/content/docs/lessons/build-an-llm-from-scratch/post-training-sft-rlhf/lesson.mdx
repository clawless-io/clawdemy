...
description: "How a pretrained base model becomes a usable assistant: supervised fine-tuning on instruction-response data, then preference tuning with RLHF or simpler DPO."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
