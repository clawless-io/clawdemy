---
title: "Post-training, SFT and RLHF: cheatsheet"
description: "One-page reference: the post-training pipeline, SFT mechanics, RLHF's three steps, DPO's one-loss simplification, and how preference tuning shifts the model."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
