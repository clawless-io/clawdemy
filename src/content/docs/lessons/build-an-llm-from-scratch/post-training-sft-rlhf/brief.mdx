---
title: "Post-training, SFT and RLHF: brief"
description: "Orientation for the post-training lesson: what SFT and preference tuning (RLHF, DPO) do, the prerequisites, and the technical-primer scope you can expect."
