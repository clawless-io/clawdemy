---
title: "Attention alternatives and MoE: cheatsheet"
description: "One-page reference: attention's cost problems, MQA, GQA, and windowing, MoE with total-vs-active parameters, and the resource-allocation view of each."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
