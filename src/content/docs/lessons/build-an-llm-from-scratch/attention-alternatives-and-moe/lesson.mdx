---
title: "Lesson: Attention alternatives and mixture of experts"
description: The two variations that make modern LLMs efficient. Why standard attention is costly, how multi-query and grouped-query attention shrink the KV cache, how sliding-window attention bounds long-context cost, and how mixture-of-experts decouples total parameters from compute per token.
sidebar:
  order: 2
  label: Lesson
artifact: lesson
