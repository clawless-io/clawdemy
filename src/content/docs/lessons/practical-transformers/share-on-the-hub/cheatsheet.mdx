---
title: "Cheatsheet: Share your work on the Hub"
description: One-page reference. Authentication, the three sharing routes with code, what a model repo contains, git-lfs, and the model-card essentials.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
...
# huggingface-cli login   # terminal
```
