---
title: "Share on the Hub: brief"
description: "An overview of publishing to the Hugging Face Hub: authenticate, compare the three upload routes, and learn why the model card is the real deliverable."
