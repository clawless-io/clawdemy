...
description: "Push a model and tokenizer to the Hugging Face Hub with push_to_hub, write a model card others can use, and see why sharing powers the whole ecosystem."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
