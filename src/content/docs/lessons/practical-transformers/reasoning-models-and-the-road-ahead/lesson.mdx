...
description: "What reasoning models add over plain LLMs, how reinforcement learning trains a model to think before answering, and where the open Hugging Face ecosystem fits."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
