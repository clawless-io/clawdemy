...
- **The landscape anchors:** DeepSeek R1 showed reasoning-via-RL at scale, Open R1 reproduces it openly, and GRPO (the RL method) lives in TRL, the same library as *SFTTrainer*. The pipeline extends: pretrain, SFT, then RL.
