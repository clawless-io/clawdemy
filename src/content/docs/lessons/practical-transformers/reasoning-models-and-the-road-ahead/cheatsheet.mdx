---
title: "Cheatsheet: Reasoning models and the road ahead"
description: One-page reference. What reasoning models add, RL vs imitation, the landscape anchors, the full ecosystem map, and the durable method.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
