---
title: "Run a model in a few lines, pipelines"
description: "Run a task with one pipeline() call, then open the box: the three steps it hides (tokenizer, model, postprocessing) rebuilt with the Auto classes."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
