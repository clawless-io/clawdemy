---
title: "Tokenizers up close: brief"
description: "What the tokenizers lesson covers: the four-stage pipeline, fast vs slow tokenizers, the three subword algorithms, and training one on a corpus."
