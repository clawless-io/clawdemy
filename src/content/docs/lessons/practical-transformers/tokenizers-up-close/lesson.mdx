...
description: "How a fast tokenizer turns text into tokens through a four-stage pipeline, why fast tokenizers are fast, the three subword algorithms, and training your own."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
