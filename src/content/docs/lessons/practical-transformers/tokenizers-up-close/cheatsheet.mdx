---
title: "Tokenizers up close: cheatsheet"
description: "Quick reference for tokenizers: the four-stage pipeline, inspecting it, fast-tokenizer powers, the three subword algorithms, and training a new one."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
