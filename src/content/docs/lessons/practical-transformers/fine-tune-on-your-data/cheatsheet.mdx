---
title: "Fine-tune a pretrained model: cheatsheet"
description: "Quick reference for fine-tuning with the Trainer: the data collator, TrainingArguments, evaluation with compute_metrics, and the efficiency switches."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
