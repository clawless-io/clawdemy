...
<ReadAlongDim
  src="https://audio.clawdemy.org/lessons/the-main-nlp-tasks-lesson.mp3"
  slug="the-main-nlp-tasks"
...
Everything else, the *map*-to-tokenize step, the *TrainingArguments* (here *Seq2SeqTrainingArguments*), the compute-metrics discipline, the push to the Hub, is the loop you already know.
