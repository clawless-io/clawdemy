...
description: "The six common NLP tasks share one loop; learn to name the task and pick the right model head, data shape, and metric, plus the two recurring wrinkles."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
