...
3. Load a model with the right head (the matching *AutoModelFor* class).
...
- **Masked and causal language modeling need no hand-made labels:** the text supervises itself via *DataCollatorForLanguageModeling* (with masking turned off for the causal version). Metric: perplexity.
