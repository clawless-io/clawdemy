---
title: "Cheatsheet: The main NLP tasks"
description: One-page reference. The shared loop, the task-to-head-to-metric map, the token-alignment and sequence-to-sequence wrinkles, and the data collators.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
