---
title: "Fine-tuning LLMs: SFT and instruction tuning"
description: "How supervised fine-tuning turns a base model into an instruction-following assistant: chat-formatted data, the SFTTrainer, and how LoRA keeps it affordable."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
