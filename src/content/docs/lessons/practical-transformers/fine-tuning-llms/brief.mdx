---
title: "Fine-tuning LLMs, in brief"
description: "Overview of supervised fine-tuning: distinguishing it from task fine-tuning, when to use SFT versus prompting, chat templates, the SFTTrainer, and LoRA."
