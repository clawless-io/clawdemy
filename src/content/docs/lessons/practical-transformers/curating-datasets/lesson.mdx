...
description: "Why data quality, not model size, often decides LLM results, and how to curate and evaluate a training dataset with Argilla, the human-in-the-loop tool."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
