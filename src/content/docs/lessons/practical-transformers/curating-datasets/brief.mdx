---
title: "Curating datasets: brief"
description: "A guide to what this lesson covers: why data quality dominates LLM results, the Argilla curation workflow, dataset evaluation checks, and prerequisites."
