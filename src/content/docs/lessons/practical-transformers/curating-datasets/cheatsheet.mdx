---
title: "Cheatsheet: Curating high-quality datasets"
description: One-page reference. Why quality dominates, what curation adds beyond cleaning, the Argilla workflow, and dataset-evaluation checks.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
