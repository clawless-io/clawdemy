...
description: "What a transformer is end to end (tokens in, tokens out, attention in the middle), why it beat older sequential models, the three shapes, and Hugging Face."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
