---
title: "Cheatsheet: What transformers do, and why they took over AI"
description: One-page reference. The working description, why transformers replaced RNNs, the three architectural shapes with examples, the timeline, the pre-train vs fine-tune split, the named limits, and the Hugging Face ecosystem.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
