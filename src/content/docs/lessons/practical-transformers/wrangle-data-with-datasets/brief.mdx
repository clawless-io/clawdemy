---
title: "Wrangling data with Datasets: brief"
description: "Overview of the datasets-library lesson: what you will learn, where it fits, prerequisites, and time to load, clean, and transform real data."
