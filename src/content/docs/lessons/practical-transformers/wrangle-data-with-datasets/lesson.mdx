...
description: "Load datasets from the Hub or your own files, then clean and transform them at scale with map, filter, and the batched flag that makes it fast."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
