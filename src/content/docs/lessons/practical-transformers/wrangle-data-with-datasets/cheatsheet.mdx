---
title: "Cheatsheet: Wrangling data with the Datasets library"
description: One-page reference. Loading, the map/filter pattern, batched=True, the handy methods, pandas interop, and saving.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
