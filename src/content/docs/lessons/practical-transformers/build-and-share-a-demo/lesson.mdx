...
Passing the string text as the input type gives you a default text box (Gradio even infers the label from your function's parameter name). When you want control, instantiate the component class instead of passing a string:
...
- **Components describe your model's input and output.** Passing a string gives defaults (like the string text); instantiate *gr.Textbox*, *gr.Image*, *gr.Audio*, and others to customize and to match non-text models.
