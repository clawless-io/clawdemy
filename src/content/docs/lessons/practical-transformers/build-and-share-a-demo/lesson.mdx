...
A Gradio demo is one object, the Gradio Interface class, wrapped around one function. Here is the "hello world":
...
- **A Gradio demo wraps the Gradio Interface class around a function and launches it.** The function does the work; the inputs and outputs are the component types. Five lines is a working web app.
