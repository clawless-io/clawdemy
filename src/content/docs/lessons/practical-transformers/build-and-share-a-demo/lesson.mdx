...
description: "Wrap any model in a browser interface with a few lines of Gradio, share it with a public link, and publish it on Hugging Face Spaces, no frontend code."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
