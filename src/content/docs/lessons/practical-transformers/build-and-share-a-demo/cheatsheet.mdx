---
title: "Build and share a demo: cheatsheet"
description: "Quick reference for building a Gradio demo: gr.Interface basics, wrapping a model, components, sharing a link, and publishing to Hugging Face Spaces."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
