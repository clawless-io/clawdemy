...
description: "t-SNE turns high-dimensional data into a 2D picture where similar points cluster. See what it reveals, what it distorts, and how to read its plots safely."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
