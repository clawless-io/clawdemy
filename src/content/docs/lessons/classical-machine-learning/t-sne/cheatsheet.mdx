---
title: "t-SNE: cheatsheet"
description: "Quick reference for t-SNE: what it does, what it preserves and does not, the three misreadings, the perplexity dial, and how it compares to PCA."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
