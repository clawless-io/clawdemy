---
title: 'Cheatsheet: From a line to a probability: logistic regression'
description: One-page reference. The sigmoid, the two-step computation, the decision boundary, a worked example, and common pitfalls.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
