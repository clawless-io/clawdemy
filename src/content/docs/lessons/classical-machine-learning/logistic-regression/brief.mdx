---
title: "Logistic regression: brief"
description: "Overview of the logistic regression lesson: what you will learn, how it builds on linear regression and gradient descent, prerequisites, and time needed."
