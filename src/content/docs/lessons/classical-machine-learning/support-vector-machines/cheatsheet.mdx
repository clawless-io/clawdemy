---
title: "Support vector machines: cheatsheet"
description: "Support vector machine quick reference: maximum margin, support vectors, the soft margin, the kernel trick, a lifting example, and pitfalls."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
