---
title: "The widest margin: support vector machines"
description: "A support vector machine picks the widest-margin boundary between two classes, set by a few support vectors; the kernel trick adds curved boundaries."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
...
<ReadAlongDim
  src="https://audio.clawdemy.org/lessons/support-vector-machines-lesson.mp3"
