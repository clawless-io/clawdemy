---
title: "Train, test, cross-validation: cheatsheet"
description: "One-page reference: the split recipes, k-fold cross-validation, useful variants (stratified, LOOCV, time-series), and the four data-leakage traps."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
