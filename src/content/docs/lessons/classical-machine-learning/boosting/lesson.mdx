...
description: "Boosting builds shallow trees in sequence, each fixing the errors of the last. See how AdaBoost and gradient boosting work and why they win on tabular data."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
