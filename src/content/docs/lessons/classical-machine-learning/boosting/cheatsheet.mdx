---
title: 'Cheatsheet: Turning weak learners strong: boosting'
description: One-page reference. The core idea, AdaBoost vs gradient boosting, a residual trace, the bagging-vs-boosting table, and pitfalls.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
