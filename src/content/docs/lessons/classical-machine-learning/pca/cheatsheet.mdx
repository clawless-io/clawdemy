---
title: 'Cheatsheet: Squeezing dimensions: PCA'
description: One-page reference. What PCs are, variance explained, when to use PCA, the scaling gotcha, and limitations.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
