---
title: 'Lesson: Overfitting and the bias-variance tradeoff'
description: "We have casually mentioned overfitting many times. Now we make it precise. There are two distinct ways a model can fail to generalize, and they pull in opposite directions. This lesson names them (bias and variance), shows why making one smaller usually makes the other larger, and teaches the foundational diagnostic in machine learning: reading training and test error together to tell underfitting from overfitting."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
