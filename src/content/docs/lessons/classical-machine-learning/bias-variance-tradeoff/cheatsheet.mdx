---
title: 'Cheatsheet: Overfitting and the bias-variance tradeoff'
description: One-page reference. The definitions, the U-curve, the train/test diagnostic, regularization, and where each method sits.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
