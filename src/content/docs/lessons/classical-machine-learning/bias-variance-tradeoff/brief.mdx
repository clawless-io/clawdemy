---
title: "Bias-variance tradeoff: brief"
description: "Overview of the bias-variance lesson: what you will learn, where it fits, the prerequisite to have first, and the time and difficulty before you start."
