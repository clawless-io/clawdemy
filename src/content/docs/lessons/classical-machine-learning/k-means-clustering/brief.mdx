---
title: "k-means clustering, in brief"
description: "An orientation to k-means clustering: what you will learn, where unsupervised learning fits, prerequisites, and the time and difficulty to expect."
