---
title: "k-means clustering: cheatsheet"
description: "One-page k-means reference: the clustering goal, the assign-update loop, a worked trace, choosing k, the failure mode, and key limitations."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
