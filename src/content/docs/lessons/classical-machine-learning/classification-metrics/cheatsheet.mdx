...
description: "One-page quick reference: the confusion matrix, formulas for accuracy, precision, recall, specificity, and F1, the ROC curve, AUC, and the threshold dial."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
