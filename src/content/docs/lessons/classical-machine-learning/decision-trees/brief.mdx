---
title: "Decision trees, in brief"
description: "Overview of the decision trees lesson: what you will learn, how it builds on logistic regression and sets up random forests, prerequisites, and time."
