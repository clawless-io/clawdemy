---
title: 'Cheatsheet: Asking the right questions: decision trees'
description: One-page reference. Tree anatomy, how to predict, how a tree is built, impurity, overfitting control, and strengths vs the key weakness.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
