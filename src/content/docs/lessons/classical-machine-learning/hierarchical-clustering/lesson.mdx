...
description: "Hierarchical clustering builds a tree of nested groups instead of a fixed cluster count. Learn the bottom-up merging and how to read and cut a dendrogram."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
