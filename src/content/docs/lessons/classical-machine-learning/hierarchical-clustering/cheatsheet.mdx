---
title: 'Cheatsheet: Building a hierarchy: hierarchical clustering'
description: One-page reference. The bottom-up procedure, reading and cutting a dendrogram, linkage types, and the comparison with k-means.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
