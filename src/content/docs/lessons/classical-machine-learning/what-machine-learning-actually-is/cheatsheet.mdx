...
description: "One-page reference: the rules-versus-data flip, the supervised and unsupervised families, the two-question classification test, and when not to use it."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
