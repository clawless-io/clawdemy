...
description: "Gradient descent is how nearly every model learns. Build the foggy-hillside intuition, meet the gradient and learning rate, then trace it downhill by hand."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
