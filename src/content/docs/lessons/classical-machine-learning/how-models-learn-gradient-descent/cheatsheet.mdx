...
description: "Gradient descent on one page: the loss landscape, the gradient and learning rate, the update loop, a worked trace, and learning-rate failure modes."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
