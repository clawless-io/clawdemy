---
title: 'Cheatsheet: Fitting a line: linear regression'
description: One-page reference. The line equation, residuals and least squares, how to read coefficients, multiple regression, and common pitfalls.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
