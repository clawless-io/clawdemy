...
description: "Linear regression: what a best-fit line means, why it minimizes the sum of squared residuals, and how to read a slope and intercept as a relationship."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
