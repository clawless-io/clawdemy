...
description: "A single decision tree overfits and is unstable. Random forests fix it: grow hundreds of trees on different data slices and let them vote to cut variance."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
