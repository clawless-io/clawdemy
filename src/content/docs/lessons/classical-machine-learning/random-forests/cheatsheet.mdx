---
title: 'Cheatsheet: Wisdom of crowds: random forests'
description: One-page reference. The ensemble idea, the two sources of randomness, why averaging helps, out-of-bag error, and the interpretability trade.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
