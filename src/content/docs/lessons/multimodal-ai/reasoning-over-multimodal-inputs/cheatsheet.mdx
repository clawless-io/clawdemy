---
title: 'Cheatsheet: Reasoning over multimodal inputs'
description: One-page reference. Reasoning models, multimodal reasoning capabilities, tool use, deliberative alignment, the four-layer stack, and failure-layer diagnostics.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
