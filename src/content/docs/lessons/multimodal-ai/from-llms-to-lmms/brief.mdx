---
title: "Large multimodal models, in brief"
description: "Overview of the encode-then-fuse vision-language recipe: the three pieces, CogVLM's visual expert, two-stage training, prerequisites, and time to read."
track: multimodal-ai
