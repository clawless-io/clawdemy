---
title: "Large multimodal models: cheatsheet"
description: "Quick reference for building multimodal models: the encode-then-fuse recipe, CogVLM's visual expert, two-stage training, and the freezing tradeoff."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
