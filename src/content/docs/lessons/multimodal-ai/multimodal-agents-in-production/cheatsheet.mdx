---
title: 'Cheatsheet: Multimodal agents in production'
description: One-page reference. Research vs production constraints, co-design loop, RLHF/RLAIF/asymmetric verification, multimodal-specific challenges, and the engineering-informs-vs-settles distinction.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
