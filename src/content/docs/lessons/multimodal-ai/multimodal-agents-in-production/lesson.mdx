...
description: "What changes when multimodal AI ships inside a real product: benchmark-vs-usability gaps, RL co-design (RLHF, RLAIF), and what engineering settles vs informs."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
