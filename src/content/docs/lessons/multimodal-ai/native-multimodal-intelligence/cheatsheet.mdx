---
title: "Native multimodal intelligence: cheatsheet"
description: "One-page reference: encode-then-fuse vs native, the unified token stream, how each modality is tokenized, plus the payoffs and the costs of joint training."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
