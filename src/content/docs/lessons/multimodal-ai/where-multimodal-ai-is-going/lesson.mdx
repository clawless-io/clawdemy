---
title: "Where multimodal AI is going"
description: "Six cross-cutting threads that unify modern multimodal AI, what the track left uncovered, and the three trajectories shaping where the field heads from 2026."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
