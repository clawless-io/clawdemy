---
title: 'Cheatsheet: Where multimodal AI is going'
description: One-page reference. The six cross-cutting threads with their L1-L9 instances, what the track did NOT cover, where the field is going, and the operational scope test.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
