---
title: "Diffusion image generation with transformers"
description: "How modern image generation switched from U-Net to transformer backbones (DiT): what the shift buys for scaling and global structure, plus MM-DiT conditioning."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
