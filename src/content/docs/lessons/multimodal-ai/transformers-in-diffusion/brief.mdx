---
title: "Diffusion image generation: brief"
description: "Diffusion image generation, in brief: learning outcomes, prerequisites, where DiT and MM-DiT fit, and read and practice time."
track: multimodal-ai
