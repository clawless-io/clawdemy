...
- **["Stable Diffusion 3" technical report (Stability AI, 2024)](https://stability.ai/news/stable-diffusion-3-research-paper)**. The MM-DiT architecture and Stable Diffusion 3's design rationale; the reference account for how text+image-token fusion via one transformer is used in a frontier production system.
