---
title: 'Cheatsheet: Transformers in diffusion models for image generation'
description: One-page reference. Diffusion recap, U-Net vs DiT, what DiT buys, MM-DiT conditioning, tradeoffs, and the scope line.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
