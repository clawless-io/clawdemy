...
description: "Multimodal AI lets one model handle text, images, audio, and video together. Learn what 'multimodal' means, the fusion challenge, and the main operating modes."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
...
<ReadAlongDim
  src="https://audio.clawdemy.org/lessons/what-multimodal-ai-actually-is-lesson.mp3"
  slug="what-multimodal-ai-actually-is"
