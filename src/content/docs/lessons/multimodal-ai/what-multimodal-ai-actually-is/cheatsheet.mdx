---
title: 'Cheatsheet: What multimodal AI actually is'
description: One-page reference. Modalities, multimodal vs multi-model, fusion strategies, operating modes, common confusions.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
