---
title: 'Cheatsheet: Multimodal world models for science'
description: One-page reference. Biological data heterogeneity, the multimodal-world-model recipe, the sharp benchmark-vs-clinical line, the operational scope test specialized to medical AI, and the named conflation pitfall.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
