...
description: "How the multimodal world model framing applies to drug discovery, and why a model passing a biological benchmark is not the same as being medically useful."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
