---
title: "JEPA and world modeling: cheatsheet"
description: "Quick reference for JEPA: generative-vs-JEPA losses, the training loop, I-JEPA and V-JEPA, the world-modeling connection, and the operational scope test."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
