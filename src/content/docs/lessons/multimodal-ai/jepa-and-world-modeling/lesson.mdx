---
title: "JEPA and world modeling"
description: "How JEPA predicts in embedding space instead of raw pixels or tokens, why that may yield better representations and world models, and where it stands today."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
