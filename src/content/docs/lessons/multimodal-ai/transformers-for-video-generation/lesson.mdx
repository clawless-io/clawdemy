...
description: "How transformers generate video with spacetime patches: extending image DiT to 3D, plus latent compression, captioned-data limits, and temporal consistency."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
