---
title: "Transformers for video generation: cheatsheet"
description: "One-page reference on transformer video generation: spacetime patches, spatial and temporal compression, training-data limits, failure modes, and scope."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
