...
- **[Full Stack Deep Learning, LLM Bootcamp: Fireside Chat with Peter Welinder](https://fullstackdeeplearning.com/llm-bootcamp/spring-2023/welinder-fireside-chat/)**. The session this lesson is built around. Apply the three reading rules as you watch: attribute (do not absorb), separate durable bets from speaker bets, and use the chat as a question generator.
