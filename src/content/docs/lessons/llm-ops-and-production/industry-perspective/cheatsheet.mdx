---
title: "Cheatsheet: Industry perspective"
description: One-page reference. Track arc, fireside reading rules, durable bets, speaker views, reader moves.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
...
| Read | Build | Try |
| --- | --- | --- |
| Session 11 fireside (this lesson's source) | L7 discipline on what you shipped | "Three tests" (L10) on your next "let's make it an agent" idea |
...
- Full Stack Deep Learning, LLM Bootcamp (Spring 2023), Session 11: Fireside Chat with Peter Welinder (OpenAI). `fullstackdeeplearning.com/llm-bootcamp`. Independent structural mirror in original prose; see references.
