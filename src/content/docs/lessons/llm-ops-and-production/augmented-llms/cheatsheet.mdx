---
title: "Augmented language models: cheatsheet"
description: "Quick reference for augmented LLMs: the seven-part RAG pipeline, RAG trade-offs, the tool-use loop, RAG-as-a-tool, and the three productive-limits view."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
