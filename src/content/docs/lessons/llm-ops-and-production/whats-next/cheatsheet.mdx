---
title: "LLM landscape: cheatsheet"
description: "One-page reference: the six LLM landscape directions, how each shifts the context, cost, and latency math, and the builder's-eye rule for new releases."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
