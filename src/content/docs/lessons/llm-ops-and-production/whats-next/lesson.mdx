---
title: "Lesson: What's next, the LLM landscape in motion"
description: A survey lesson opening Phase 3. The directions the LLM application landscape is moving (longer context, multimodality, smaller specialized models, the build-vs-buy spectrum, agents, reasoning models), what each changes for a builder, and how each sets up the next three lessons.
sidebar:
  order: 2
  label: Lesson
artifact: lesson
