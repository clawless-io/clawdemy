...
• Full Stack Deep Learning, "LLM Bootcamp" (Spring 2023), Session 10:
    Agents
...
This lesson mirrors the structure of Session 10 (agents as a production
...
- **[Full Stack Deep Learning, LLM Bootcamp, Session 10: Agents](https://fullstackdeeplearning.com/llm-bootcamp/)** with Harrison Chase (LangChain). The session this lesson mirrors. The recorded version brings the framework-author perspective with examples drawn from LangChain's early agent work.
