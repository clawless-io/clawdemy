...
- **[Full Stack Deep Learning, LLM Bootcamp: Agents](https://fullstackdeeplearning.com/llm-bootcamp/)** with Harrison Chase (LangChain). The session this lesson mirrors. The recorded version brings the framework-author perspective with examples drawn from LangChain's early agent work.
