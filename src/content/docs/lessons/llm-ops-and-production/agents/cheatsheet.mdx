...
- Full Stack Deep Learning, LLM Bootcamp (Spring 2023), Session 10: Agents (guest: Harrison Chase, LangChain). `fullstackdeeplearning.com/llm-bootcamp`. Independent structural mirror in original prose; see references.
