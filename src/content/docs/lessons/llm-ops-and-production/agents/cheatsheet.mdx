---
title: "LLM agents: cheatsheet"
description: "One-page reference for LLM agents: the loop, the patterns, the three tests, the failure modes, build practices, and the boundary disclaimers."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
