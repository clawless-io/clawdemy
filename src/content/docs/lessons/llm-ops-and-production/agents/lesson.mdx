---
title: "LLM agents"
description: "What an LLM agent is (a tool-use loop where the model decides when to stop), the common patterns, when to use one, the failure modes, and how to ship it."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
