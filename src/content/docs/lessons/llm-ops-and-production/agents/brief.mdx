---
title: "LLM agents: brief"
description: "A primer on LLM agents: the loop, the three foundational patterns, the three tests for when to use one, the five failure modes, and how to operate one."
