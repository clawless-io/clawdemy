---
title: "LLMOps: keep AI apps working over time"
description: "The operational layer that keeps an LLM app working over time: observability, evaluation, prompt versioning, cost and latency monitoring, regression testing."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
