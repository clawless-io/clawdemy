---
title: "LLMOps: cheatsheet"
description: "One-page LLMOps reference: the five pillars, per-request log fields, a smallest-practical-first stack, tooling options, and scope boundaries."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
