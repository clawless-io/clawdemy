---
title: "LLMOps, in brief"
description: "A guided tour of LLMOps: the five pillars, a per-request log schema, evaluation in production, prompt versioning, and regression testing for safe changes."
...
<SourceLecture
  ...
  title="Full Stack Deep Learning, LLM Bootcamp: LLMOps"
