...
- **[Full Stack Deep Learning, LLM Bootcamp: UX for Language User Interfaces](https://fullstackdeeplearning.com/llm-bootcamp/spring-2023/ux-for-luis/)** by Charles Frye, Sergey Karayev, and Josh Tobin. The session this lesson mirrors. The recorded version walks the same patterns with screenshots of real LUIs.
