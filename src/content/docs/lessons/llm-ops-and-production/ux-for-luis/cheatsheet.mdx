---
title: "UX for language user interfaces: cheatsheet"
description: "One-page reference for LUI UX: the five core patterns, recoverable-failure modes, supporting details, and a critique-this-UX checklist."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
