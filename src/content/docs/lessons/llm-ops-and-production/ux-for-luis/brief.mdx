---
title: "UX for language user interfaces: brief"
description: "The five core LUI UX patterns (streaming, citations, regeneration, hedging, recoverable failure), where the lesson fits, prerequisites, and supporting details."
