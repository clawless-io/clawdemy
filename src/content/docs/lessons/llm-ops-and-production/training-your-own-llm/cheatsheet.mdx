---
title: "Cheatsheet: Training your own LLM"
description: One-page reference. Decision criteria, pipeline, tools, economics, mix-architecture fit, boundary disclaimers.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
...
- Full Stack Deep Learning, LLM Bootcamp (Spring 2023), Session 9: How to train your own LLM (guest: Reza Shabani, Replit). `fullstackdeeplearning.com/llm-bootcamp`. Independent structural mirror in original prose; see references.
