...
- Full Stack Deep Learning, LLM Bootcamp (Spring 2023), Session 2: LLM Foundations. `fullstackdeeplearning.com/llm-bootcamp`. Independent structural mirror in original prose; see references.
