...
description: "One-page reference: the three API-level properties, the generation loop, sampling controls (temperature, top_p, max_tokens), and the three productive limits."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
