...
description: "The highest-leverage LLM-app skill: the prompt toolkit (clarity, format, few-shot, chain-of-thought, system prompts), versioning, and prompt-fix triage."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
