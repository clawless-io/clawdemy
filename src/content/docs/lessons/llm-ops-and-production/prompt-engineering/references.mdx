...
• Full Stack Deep Learning, "LLM Bootcamp" (Spring 2023), Session 3:
...
This lesson mirrors the structure of Session 3 (the prompt-engineering
...
- **[Full Stack Deep Learning, LLM Bootcamp, Session 3: Learn to Spell: Prompt Engineering](https://fullstackdeeplearning.com/llm-bootcamp/)** by Charles Frye, Sergey Karayev, and Josh Tobin. The session this lesson mirrors. The recorded version walks the same toolkit with worked examples on real tasks.
