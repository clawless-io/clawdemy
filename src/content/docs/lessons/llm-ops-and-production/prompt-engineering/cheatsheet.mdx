...
description: "Prompt-engineering quick reference: the toolkit table, prompt-fix vs code-fix triage, the version-and-test discipline, and a few-shot template."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
