---
title: "Prompt engineering: brief"
description: "Orientation for the prompt-engineering lesson: the toolkit, prompt-fix vs code-fix triage, the versioning-and-testing discipline, and where prompts run out."
