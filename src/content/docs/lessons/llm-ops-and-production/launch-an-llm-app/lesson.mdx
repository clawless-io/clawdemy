...
description: "The five parts of a minimum-viable LLM app, a worked example that ships one in about thirty lines of Python, and an honest map of what it does not yet do."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
