...
Run with `streamlit run app.py` and your environment variable set, and you have a working LLM application reachable in a browser. About thirty lines. The Streamlit decorators handle the UI; the `Anthropic` client handles the API call; your prompt is the spec; your code is the wiring.
