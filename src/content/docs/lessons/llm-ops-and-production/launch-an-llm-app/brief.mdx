---
title: "Launch an LLM app, in brief"
description: "What this opening lesson covers: the five parts of a minimal LLM app, prerequisites, where it fits in the track, and the skills you will walk away with."
