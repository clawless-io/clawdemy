---
title: "Cheatsheet: Project walkthrough"
description: One-page reference. The production decisions inside a real LLM app + a checklist you can read against your own.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
...
- Full Stack Deep Learning, LLM Bootcamp (Spring 2023), Session 5: Project Walkthrough (askFSDL). `fullstackdeeplearning.com/llm-bootcamp`. Independent structural mirror in original prose; see references.
