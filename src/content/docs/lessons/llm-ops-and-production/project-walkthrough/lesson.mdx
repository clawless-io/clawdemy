---
title: "Project walkthrough: a real LLM app end to end"
description: "Read the production decisions inside askFSDL, a real RAG Q&A app: scoped corpus, chunking, source-carrying retrieval, streaming, and logging that seeds LLMOps."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
