---
title: "Cheatsheet: Your starting point: write down what you're protecting and from whom"
description: "One-page reference. Two questions, four asset buckets, five adversary categories, three pitfalls, a 3-step recovery for when you are stuck, and where this seed goes next."
sidebar:
  order: 5
  label: Cheatsheet
...
| **You, in a moment of inattention** | Pasting a sensitive thing into the wrong window, sending a draft to the wrong recipient, forgetting which conversation a session was in. The most common adversary is your own next click. Naming it is honest planning. |
