...
- **You, in a moment of inattention.** Pasting a sensitive thing into the wrong window, sending a draft to the wrong recipient, forgetting which conversation a particular session was in. The most common adversary is your own next click. Naming it is not self-blame; it is honest planning.
...
**What you can do right now.** Write your own version. Keep it to five sentences or fewer. Use your own situation, not a hypothetical. If you are stuck on the first question, name three buckets from the list above, then one specific instance of each. If you are stuck on the second, write down every party whose possession of your assets would cost you something, then cross out the ones whose possession would not actually cost much. Keep the paragraph somewhere only you can read it; this is a planning artifact for you, not for sharing.
