---
title: "Your starting point: what to protect, from whom"
description: "Turn three generic AI worries into a personal threat model: one short paragraph naming what you are protecting and from whom, using EFF's two-question frame."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
