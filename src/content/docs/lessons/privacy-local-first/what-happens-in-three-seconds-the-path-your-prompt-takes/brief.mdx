...
- **CDN (Content Delivery Network):** the vendor's geographically distributed front-door infrastructure. The first place inside the vendor's systems where messages exist in plaintext; what gets logged versus what passes through is a vendor policy choice.
