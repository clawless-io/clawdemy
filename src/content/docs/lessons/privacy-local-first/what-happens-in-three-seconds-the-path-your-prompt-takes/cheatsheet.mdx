---
title: "Cheatsheet: What happens in three seconds: the path your prompt takes"
description: "One-page reference. Seven steps, two words (Inputs and Outputs), three pitfalls, and where each phase adds to the picture."
sidebar:
  order: 5
  label: Cheatsheet
...
This is the canonical vendor vocabulary. Almost every major AI vendor's privacy policy uses these two exact words. When you see "we use your Inputs and Outputs to improve our Services," that is the trip you just learned.
