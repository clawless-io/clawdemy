...
Inputs are the user's messages (prompts). Outputs are the model's replies. The two words are the canonical vocabulary used in almost every major AI vendor's privacy policy. When a policy says "we use your Inputs and Outputs to improve our Services," it is talking about the messages you sent and the replies that came back. Learning these two words means you can read the policy sentences they appear in without having to translate from policy-language to plain language each time.
...
Inputs are the user's messages (prompts). Outputs are the model's replies. The two words are the canonical vocabulary used in almost every major AI vendor's privacy policy. When the policy says "we use your Inputs and Outputs to improve our Services," it is talking about the messages you sent and the replies that came back.
