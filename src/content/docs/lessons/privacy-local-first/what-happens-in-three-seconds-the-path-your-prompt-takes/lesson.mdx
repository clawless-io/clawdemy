---
title: "The path your prompt takes in three seconds"
description: "Trace what happens when you click Send in an AI tool: the seven-step path your message and the reply take in three seconds, and what each system can see."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
