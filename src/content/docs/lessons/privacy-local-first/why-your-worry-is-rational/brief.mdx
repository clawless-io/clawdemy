---
title: "AI privacy worries: brief"
description: "Overview of the lesson that names three AI privacy worries (surveillance, storage leaks, vendor lock-in) and a quick test for each before you paste."
