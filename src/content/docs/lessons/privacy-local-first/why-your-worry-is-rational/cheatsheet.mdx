...
| Pitfall | Reality |
| --- | --- |
| **"Privacy mode" is a privacy guarantee** | Read what each mode actually promises. A "temporary chat" or "incognito" mode may limit training use and history but still retain the conversation for up to 30 days. The specific protections are real; they are narrower than the word suggests. |
