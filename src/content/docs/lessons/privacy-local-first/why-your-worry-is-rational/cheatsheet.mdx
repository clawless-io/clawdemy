---
title: "AI privacy worries: cheatsheet"
description: "One-page AI privacy reference: three worries, one test each, three pitfalls to dodge, a gut check before you paste, and where each worry gets resolved."
sidebar:
  order: 5
  label: Cheatsheet
