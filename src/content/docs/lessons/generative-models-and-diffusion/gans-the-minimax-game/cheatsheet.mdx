---
title: "Cheatsheet: GANs, the minimax game"
description: One-page reference. The minimax objective, the optimal discriminator, the Jensen-Shannon divergence interpretation, a worked numerical example, paradigm-level failure modes (mode collapse, instability), and what GANs are and are not good at.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
