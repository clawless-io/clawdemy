...
description: "How GANs train by a minimax game between a generator and a discriminator, why the implicit divergence is Jensen-Shannon, and why mode collapse is built in."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
