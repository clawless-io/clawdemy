---
title: "VAE training: the reparameterization trick"
description: "How variational autoencoders become trainable: the reparameterization trick makes the ELBO differentiable, and a closed-form Gaussian KL gives a cheap loss."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
