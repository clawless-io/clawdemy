---
title: "VAE reparameterization trick: cheatsheet"
description: "One-page VAE reference: the architecture, the reparameterization trick, the closed-form Gaussian KL, the per-example loss, and the six-step training loop."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
