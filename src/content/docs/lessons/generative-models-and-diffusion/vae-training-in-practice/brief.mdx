---
title: "VAE reparameterization trick, in brief"
description: "Brief on training a variational autoencoder: the reparameterization trick, the closed-form Gaussian KL term, and the per-example reconstruction-plus-KL loss."
