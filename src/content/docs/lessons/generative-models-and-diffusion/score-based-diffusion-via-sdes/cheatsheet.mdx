---
title: "Cheatsheet: Score-based diffusion via SDEs"
description: Quick reference for the forward and reverse SDEs, the noise-predictor / score function identity, and the probability flow ODE that gives a deterministic sampler with tractable likelihood. The continuous-time framework underlying L11, L12, and L13.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
