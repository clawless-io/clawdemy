---
title: "Score-based diffusion via SDEs: brief"
description: "What to expect from the SDE diffusion lesson: prerequisites, outcomes, time, and how score matching, DDPM, and DDIM unify into one continuous-time framework."
