---
title: "WGAN-GP: Wasserstein loss, gradient penalty"
description: "Swap the GAN's Jensen-Shannon divergence for the Wasserstein distance and enforce the 1-Lipschitz critic with a gradient penalty for stable WGAN-GP training."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
