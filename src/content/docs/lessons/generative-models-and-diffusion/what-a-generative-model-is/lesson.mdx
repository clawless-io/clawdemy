---
title: "What a generative model is: the four paradigms"
description: "A generative model learns a distribution well enough to sample new data. Defines what generative means and maps the four paradigms behind modern AI systems."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
