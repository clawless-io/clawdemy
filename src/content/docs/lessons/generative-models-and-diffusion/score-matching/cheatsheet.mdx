---
title: "Score matching: cheatsheet"
description: "Quick reference for score matching: the explicit and denoising objectives, the score-as-noise-predictor identity, Langevin sampling, and worked examples."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
