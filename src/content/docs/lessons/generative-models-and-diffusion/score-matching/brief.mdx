---
title: "Score matching, in brief"
description: "Orientation for the score matching lesson: the objectives, why the explicit form does not scale, denoising score matching, and the bridge to diffusion."
