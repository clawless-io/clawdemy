...
description: "Score matching estimates the score directly, no partition function; denoising score matching reduces it to a noise-prediction loss that sets up diffusion."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
