---
title: "Autoregressive models: brief"
description: "A brief on factoring distributions with the chain rule, training by negative log-likelihood, and enforcing causality in autoregressive models."
