---
title: "Autoregressive models and the chain rule"
description: "How autoregressive models use the chain rule to factor a joint distribution into conditionals, then train by next-token negative log-likelihood."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
