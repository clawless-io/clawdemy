---
title: "Autoregressive models: cheatsheet"
description: "One-page reference: the chain rule, negative log-likelihood objective, causality via masking, sampling cost, and autoregressive trade-offs."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
