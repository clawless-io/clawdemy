---
title: "Cheatsheet: Diffusion models II, training and sampling"
description: Quick reference for DDIM (deterministic non-Markovian sampler), classifier-free guidance (conditioning trick), and the latency-quality Pareto frontier. The production-grade diffusion paradigm in one page.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
