...
description: "What made diffusion practical: DDIM (a deterministic sampler that needs far fewer steps), classifier-free guidance, and the latency-quality Pareto frontier."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
