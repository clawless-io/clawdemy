---
title: "Latent variables and the ELBO: cheatsheet"
description: "One-page reference for the ELBO: the intractable marginal, Jensen derivation, the reconstruction and KL split, the gap identity, and a worked binary example."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
