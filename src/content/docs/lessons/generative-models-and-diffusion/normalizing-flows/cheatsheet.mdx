---
title: "Cheatsheet: Normalizing flows, change of variables for distributions"
description: One-page reference. The change-of-variables formula in 1D and many dimensions, the NLL training objective for flows, worked numerical examples, architectural constraints, and how flows compare with the other paradigms.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
