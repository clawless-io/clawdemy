---
title: "Energy-based models, the partition problem"
description: "An energy-based model uses a free energy function over an intractable partition function. Why that blocks maximum likelihood, and the score-function escape."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
