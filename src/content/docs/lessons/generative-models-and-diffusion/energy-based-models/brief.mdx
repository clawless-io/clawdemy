---
title: "Energy-based models, in brief"
description: "Overview of the energy-based model lesson: what you will learn, where it fits, prerequisites, and the math, from the EBM density to the score-function escape."
