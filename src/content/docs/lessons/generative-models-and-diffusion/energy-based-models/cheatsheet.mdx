---
title: "Cheatsheet: Energy-based models, the partition-function problem"
description: One-page reference. The EBM density, why Z is intractable, the maximum-likelihood gradient with positive and negative phases, MCMC sampling and contrastive divergence, the score-function escape route, and the bridge to score matching and diffusion.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
