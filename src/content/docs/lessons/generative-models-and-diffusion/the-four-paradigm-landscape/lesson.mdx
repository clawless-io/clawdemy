---
title: "Lesson: The four-paradigm landscape and where modern systems sit"
description: The capstone of Track 19. Returns to the four-paradigm map from lesson 1 with every paradigm's training objective, sampling procedure, and trade-off characterized in full from the 13 intervening lessons. Places modern systems (autoregressive language models, Stable Diffusion and other latent diffusion systems, GAN-based face generators, latent-diffusion hybrids, and multimodal models) on the map explicitly. Closes the track on the same map it opened with, this time with the math underneath.
artifact: lesson
sidebar:
  order: 2
  label: Lesson
