---
title: "Four-paradigm landscape: cheatsheet"
description: "Quick reference for the four paradigms (objective, sampling, trade-offs), placements of modern systems on the map, and the paradigm-fluency reading procedure."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
