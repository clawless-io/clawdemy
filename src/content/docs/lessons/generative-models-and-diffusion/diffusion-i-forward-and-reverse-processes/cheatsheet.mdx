---
title: "Diffusion models I: cheatsheet"
description: "One-page reference for DDPM diffusion: the forward and reverse chains, the closed-form shortcut, the simplified noise-prediction loss, and the sampling loop."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
