---
title: "Diffusion models I: forward and reverse processes"
description: "How diffusion models work: a fixed forward chain noises data into Gaussian, a learned reverse chain denoises back, and the DDPM training and sampling loops."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
