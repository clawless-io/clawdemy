---
title: "Cheatsheet: Evaluating generative models"
description: One-page reference. Why likelihood isn't a universal metric, the IS and FID formulas with a 1D worked example, precision/recall and human studies, and the evaluation-methods-as-paradigm-fingerprint cross-paradigm table.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
