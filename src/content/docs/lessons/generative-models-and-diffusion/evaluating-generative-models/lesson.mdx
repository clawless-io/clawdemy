...
description: "How to compare VAEs, GANs, and diffusion models when likelihood isn't universal: FID, Inception Score, precision and recall, and human preference studies."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
