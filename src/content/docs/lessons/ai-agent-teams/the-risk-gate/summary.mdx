...
- **The gate is a separate role.** The Portfolio Manager argued none of the three positions. It reads the whole risk discussion plus the earlier plans and issues the final decision (one of five stances: Buy, Overweight, Hold, Underweight, Sell), written into shared state as the final trade decision.
