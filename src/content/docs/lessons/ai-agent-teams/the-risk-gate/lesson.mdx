...
Everything below is quoted from that frozen snapshot (the short code `7e9e7b8` marks the exact version). The three risk seats live in the risk-management folder (`tradingagents/agents/risk_mgmt/`), one file each.
