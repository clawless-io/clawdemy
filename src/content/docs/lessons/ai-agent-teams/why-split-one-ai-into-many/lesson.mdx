...
In the foundational agent track you learned that splitting work across a team of agents is a deliberate tradeoff. Done for the right task, it makes a system better. Done for the wrong one, it just adds cost and confusion. This track answers that question by watching a real system that made the bet, so by the end you could design one of your own. This first lesson is the map: who is on the team, why it is split the way it is, and the one design choice that matters most. We do not read any code yet. That starts next lesson.
