---
title: "Cheatsheet: How few-shot examples teach in context"
description: "One-page reference. The in-context learning concept, the zero/one/few vocabulary, why few-shot works, when it fails, and the practical recipe for getting consistent results."
sidebar:
  order: 5
  label: Cheatsheet
