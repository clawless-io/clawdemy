...
description: "In-context learning and few-shot prompting: what zero-shot, one-shot, and few-shot mean, why examples work, when they fail, and when instructions do better."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
