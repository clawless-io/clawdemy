---
title: "Self-attention: cheatsheet"
description: "One-page self-attention reference: the formula, the three steps, Q/K/V mapping, the library analogy, self vs cross, the worked numbers, and pitfalls to dodge."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
