---
title: "How attention decides which word goes with which"
description: "Walk through self-attention: what it does (the animal-street-it example), why RNNs fell short, the query-key-value intuition, and one attention pass by hand."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
