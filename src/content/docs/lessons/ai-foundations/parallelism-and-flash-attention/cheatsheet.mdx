---
title: "Parallelism and Flash Attention: cheatsheet"
description: "One-page reference: the training memory budget, data parallelism, the three ZeRO levels, model parallelism variants, and Flash Attention (HBM to SRAM tiling)."
sidebar:
  order: 5
  label: Cheatsheet
