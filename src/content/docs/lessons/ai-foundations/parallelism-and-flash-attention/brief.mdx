---
title: "Parallelism and Flash Attention: brief"
description: "Brief for the parallelism and Flash Attention lesson: prerequisites, learning outcomes, and how the four memory tricks fit into Phase 3 pretraining."
