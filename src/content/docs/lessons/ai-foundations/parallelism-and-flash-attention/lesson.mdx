---
title: "Pretraining: parallelism and Flash Attention"
description: "A Chinchilla-scale pretraining run does not fit on one GPU. Covers the four memory tricks: data parallelism, ZeRO, model parallelism, and Flash Attention."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
