---
title: "How prompting works, in brief"
description: "Brief for the prompting lesson: what a prompt is at the token level, what system prompts do, prompt injection, and where it sits in Phase 5 of Track 5."
