---
title: "How prompting works: cheatsheet"
description: "One-page reference: what a prompt is at the token level, what system prompts do and don't do, prompt injection, common pitfalls, and a glossary."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
