---
title: "How prompting works: system prompts, injection"
description: "What a prompt is at the token level, what system prompts do and don't enforce, and why every instruction-tuned model is vulnerable to prompt injection."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
