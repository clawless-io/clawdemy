---
title: "Quantization and mixed precision: cheatsheet"
description: "One-page reference: floating-point bit structure, the four standard formats, what lower precision saves, and quantization versus mixed precision training."
sidebar:
  order: 5
  label: Cheatsheet
