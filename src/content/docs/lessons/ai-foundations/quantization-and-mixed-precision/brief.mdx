---
title: "Quantization and mixed precision, in brief"
description: "Brief for the Phase 3 closer on precision: what floating-point bits mean, why lower precision saves memory and compute, plus quantization and mixed precision."
