---
title: "Why precision matters: quantization"
description: "Lower precision means less memory per parameter and faster compute. Quantization shrinks a trained model; mixed precision training shrinks the training run."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
