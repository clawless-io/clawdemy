---
title: "Why scale matters: scaling laws and Chinchilla"
description: "Why throwing more compute at next-token prediction works: Kaplan scaling laws, the Chinchilla rule of 20 tokens per parameter, and why GPT-3 was undertrained."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
