---
title: "Scaling laws and Chinchilla: cheatsheet"
description: "One-page reference on scaling laws and the Chinchilla rule: FLOPs, the Kaplan results, the 20-tokens-per-parameter rule, and the GPT-3 worked check."
sidebar:
  order: 5
  label: Cheatsheet
