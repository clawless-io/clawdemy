...
<ReadAlongLesson src="https://audio.clawdemy.org/lessons/how-ai-reads-tokens-lesson.mp3"
  slug="how-ai-reads-tokens" approxMinutes={20} />

AI can write a poem about strawberries. Ask older models how many Rs are in the word and they get it wrong; ask the latest frontier models (Llama 4, o3, GPT-5.x) and most of them now answer three, because the makers trained the failure mode away after it became a meme.
