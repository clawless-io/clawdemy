...
description: "How tokenization turns text into the integer IDs models read, why neither words nor characters work as units, BPE worked by hand, and the strawberry puzzle."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
