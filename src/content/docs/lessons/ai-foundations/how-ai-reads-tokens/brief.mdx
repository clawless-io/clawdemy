---
title: "Tokenization, in brief"
description: "Overview of the tokenization lesson: why models read tokens not words or letters, what byte-pair encoding does, where it fits in Track 5, and learning goals."
