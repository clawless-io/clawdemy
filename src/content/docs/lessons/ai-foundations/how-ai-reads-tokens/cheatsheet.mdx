---
title: "Cheatsheet: How AI reads: turning text into tokens"
description: One-page reference. The pipeline, the vocabulary tradeoff, BPE in four steps, the strawberry mystery, special tokens, pricing rules, and pitfalls to dodge.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
