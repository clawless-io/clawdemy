---
title: "DistilBERT and RoBERTa: cheatsheet"
description: "One-page reference on BERT's two derivatives: the three BERT limitations, knowledge distillation, what DistilBERT does, and what RoBERTa changes."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
