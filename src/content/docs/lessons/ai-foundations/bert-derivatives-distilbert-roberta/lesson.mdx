...
<ReadAlongLesson src="https://audio.clawdemy.org/lessons/bert-derivatives-distilbert-roberta-lesson.mp3"
  slug="bert-derivatives-distilbert-roberta" approxMinutes={18} />
