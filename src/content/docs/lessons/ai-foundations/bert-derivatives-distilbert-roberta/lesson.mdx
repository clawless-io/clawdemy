---
title: "DistilBERT and RoBERTa: improving on BERT"
description: "Two BERT derivatives, explained: DistilBERT shrinks it via knowledge distillation; RoBERTa drops NSP, masks dynamically, and trains on more data."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
