---
title: "Encoder-decoder, T5, span corruption: brief"
description: "Brief for the encoder-decoder and T5 lesson: the T5 family (T5, mT5, byT5), span corruption pretraining, and why decoder-only models eventually won out."
