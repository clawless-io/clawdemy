...
<ReadAlongLesson src="https://audio.clawdemy.org/lessons/encoder-decoder-and-t5-span-corruption-lesson.mp3"
  slug="encoder-decoder-and-t5-span-corruption" approxMinutes={18} />
