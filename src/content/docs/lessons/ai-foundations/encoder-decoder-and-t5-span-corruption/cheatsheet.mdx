---
title: "Encoder-decoder and T5: cheatsheet"
description: "One-page reference: the three architectural branches, the T5 family (T5, mT5, byT5), the span corruption mechanism, and why decoder-only models won at scale."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
