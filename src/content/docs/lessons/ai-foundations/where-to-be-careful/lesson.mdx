---
title: "Lesson: Where to be careful, a safety lens on what you've learned"
...
<ReadAlongLesson src="https://audio.clawdemy.org/lessons/where-to-be-careful-lesson.mp3"
  slug="where-to-be-careful" approxMinutes={13} />
