---
title: "Cheatsheet: Where to be careful"
description: "One-page reference. Each phase's safety thread, the cross-cutting principles, and the five-question frame for evaluating any AI system."
sidebar:
  order: 5
  label: Cheatsheet
