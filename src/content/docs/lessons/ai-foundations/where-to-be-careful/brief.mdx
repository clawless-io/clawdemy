---
title: "AI safety threads, in brief"
description: "Overview of the AI safety recap lesson: the per-phase threads it covers, where it fits in the foundations track, prerequisites, and learning outcomes."
