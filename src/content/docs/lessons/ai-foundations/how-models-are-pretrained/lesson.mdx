...
[spam data] -> [spam   [pretraining: huge data, no labels]
              model]                |
                                    v
[sentiment]    [sent.    [pretrained base model]
data       -> model]      /        |       \
                         v         v        v
[topic]       [topic]   [tune    [tune    [tune
data       -> model]    for      for      for
                        spam]   sentiment] topic]
```
