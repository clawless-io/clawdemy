---
title: "Pretraining: predicting the next word"
description: "How decoder-only models are pretrained on the open internet by predicting the next token, the single objective behind nearly every language ability."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
