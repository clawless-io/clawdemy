---
title: "How models know word order: cheatsheet"
description: "Quick reference: why position information must be added explicitly, the learned and sinusoidal schemes, plus the sin/cos position formula."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
