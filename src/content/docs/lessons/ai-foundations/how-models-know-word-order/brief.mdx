---
title: "How models know word order: brief"
description: "Phase 1 brief on why models need word order added explicitly, plus the learned and sinusoidal position schemes the 2017 transformer paper proposed."
