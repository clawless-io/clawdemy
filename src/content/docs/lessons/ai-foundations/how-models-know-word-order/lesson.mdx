...
description: "Why transformers lose word order when they process tokens in parallel, and the two position embedding schemes (learned and sinusoidal) the 2017 paper added."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
