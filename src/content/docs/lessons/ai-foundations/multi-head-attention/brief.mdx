---
title: "Multi-head attention, in brief"
description: "Brief for the multi-head attention lesson: why one head must choose, the split-run-concatenate pattern, the 12-head 768-dim flow, plus MQA, GQA, MLA variants."
