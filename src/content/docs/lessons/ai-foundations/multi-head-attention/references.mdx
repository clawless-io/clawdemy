...
- **[Stanford CME 295 cheatsheet](https://cme295.stanford.edu/cheatsheet/)** by the Amidi twins. MIT-licensed. Useful as a single-page recall sheet right before lesson 5 (the full transformer block); the architecture diagram puts multi-head in context with the rest of the layer.
