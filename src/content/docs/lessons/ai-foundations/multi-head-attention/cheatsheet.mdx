...
Real transformer attention is multi-head. `h` heads run in parallel; outputs concatenate and project. The single-head story from lesson 1 was the simplification.
