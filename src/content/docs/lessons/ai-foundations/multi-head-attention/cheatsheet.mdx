---
title: "Multi-head attention: cheatsheet"
description: "Multi-head attention cheatsheet: the split-run-concatenate pattern, the 768-dim dimension flow, key formulas, model-card terms, pitfalls, and a glossary."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
