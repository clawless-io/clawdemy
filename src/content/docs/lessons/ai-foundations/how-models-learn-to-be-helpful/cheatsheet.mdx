---
title: "Cheatsheet: How instruction tuning makes a model helpful"
description: One-page reference. Pretraining versus SFT, the SFT mechanism, what SFT changes versus what stays the same, LoRA, the structural limitation, common pitfalls, glossary.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
