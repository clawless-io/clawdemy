...
description: "Supervised fine-tuning (SFT) turns a pretrained autocompleter into an instruction-following assistant by teaching it response shape, not new knowledge."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
