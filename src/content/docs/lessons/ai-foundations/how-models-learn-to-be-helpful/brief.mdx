---
title: "Instruction tuning (SFT), in brief"
description: "How supervised fine-tuning (SFT) bridges a base model to an assistant: what it changes (response shape) versus keeps (knowledge), plus LoRA and its limit."
