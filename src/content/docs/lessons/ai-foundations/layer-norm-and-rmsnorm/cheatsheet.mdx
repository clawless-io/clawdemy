---
title: "Cheatsheet: Why transformers need stability to learn: LayerNorm, pre-norm, and RMSNorm"
description: One-page reference. The mechanism, LayerNorm vs BatchNorm, post-norm vs pre-norm placement, RMSNorm as the modern simplification.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
