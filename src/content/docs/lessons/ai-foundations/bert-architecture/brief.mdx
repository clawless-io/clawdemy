---
title: "BERT architecture, in brief"
description: "Brief for BERT's architecture lesson: the encoder-only branch, bidirectional self-attention, the CLS and SEP tokens, and three additive input embeddings."
