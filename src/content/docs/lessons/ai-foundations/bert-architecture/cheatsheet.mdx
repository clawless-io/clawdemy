---
title: "BERT architecture: cheatsheet"
description: "One-page reference for BERT's architecture: encoder-only branch, the CLS and SEP tokens, three additive input embeddings, and WordPiece tokenization."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
