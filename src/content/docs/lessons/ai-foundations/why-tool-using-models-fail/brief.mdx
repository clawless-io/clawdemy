---
title: "Why tool-using models fail, in brief"
description: "Brief for the tool-use failures lesson: the three buckets, nine named sub-failures, where it fits in Phase 7, prerequisites, and time and difficulty."
