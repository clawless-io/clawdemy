...
description: "Tool-use failures fall into three buckets (tool prediction, tool execution, response synthesis). Walk nine named sub-failures and the debug recipe for each."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
