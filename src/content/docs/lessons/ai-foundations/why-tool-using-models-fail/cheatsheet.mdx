---
title: "Why tool-using models fail: cheatsheet"
description: "One-page reference for tool-use failures: the three buckets, nine named sub-failures with causes and fixes, and the debugging recipe."
sidebar:
  order: 5
  label: Cheatsheet
