---
title: "How a transformer generates text: brief"
description: "Brief for the text generation lesson: what it covers (autoregressive prediction loop, decoding strategies, KV caching), prerequisites, outcomes, and timing."
