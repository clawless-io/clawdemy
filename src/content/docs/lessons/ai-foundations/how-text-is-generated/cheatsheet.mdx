---
title: "Cheatsheet: Token by token: how a transformer generates text"
description: One-page reference. The prediction loop, decoding strategies, temperature, stop conditions, KV caching, and a glossary.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
