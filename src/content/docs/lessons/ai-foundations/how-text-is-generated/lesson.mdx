...
description: "How a transformer generates text one token at a time: the prediction loop, decoding strategies (greedy, top-k, top-p, temperature), KV caching, and API knobs."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
