...
description: "An agent is a tool-using LLM that loops. Learn the observe-plan-act pattern, the cumulative-error limit, multi-agent setups, and the safety threads."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
