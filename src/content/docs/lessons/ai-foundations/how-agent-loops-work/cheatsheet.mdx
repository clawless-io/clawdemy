---
title: "Agent loops: cheatsheet"
description: "One-page reference to agent loops: the agent definition, the observe-plan-act loop, the cumulative-error multiplier, multi-agent setups, and safety threads."
sidebar:
  order: 5
  label: Cheatsheet
