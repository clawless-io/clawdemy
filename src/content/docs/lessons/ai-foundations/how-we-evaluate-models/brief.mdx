---
title: "LLM-as-a-Judge: brief"
description: "Brief overview of the LLM-as-a-Judge lesson: what LaaJ is, pointwise vs pairwise, why it works, and the three biases plus prerequisites and time."
