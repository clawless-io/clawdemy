...
description: "How LLM-as-a-Judge uses one LLM to score another's output, why it works, and the three biases (position, verbosity, self-enhancement) and their fixes."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
