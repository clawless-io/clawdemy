...
description: "Read AI benchmark claims carefully: what the major categories (knowledge, reasoning, coding, common sense) measure, and why scores can outpace real capability."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
