---
title: "Cheatsheet: Why benchmarks can mislead"
description: "One-page reference. The major benchmark categories, what each measures, why scores can rise faster than capability, and the reading checklist."
sidebar:
  order: 5
  label: Cheatsheet
