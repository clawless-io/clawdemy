...
description: "How preference data closes the gap SFT leaves: what a preference pair is, why pairwise comparison wins, and how a reward model is trained to score responses."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
