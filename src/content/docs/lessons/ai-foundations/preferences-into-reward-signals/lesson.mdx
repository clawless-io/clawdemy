...
<AudioPlayer src="https://audio.clawdemy.org/lessons/preferences-into-reward-signals-lesson.mp3" approxMinutes={19} />
...
- **Two responses come from the same SFT model with positive-temperature decoding.** The variation between candidates is sampling noise, not model difference.
