---
title: "Preferences into reward signals: brief"
description: "A brief for the reward-model lesson: how preference pairs fill the gap SFT leaves, where this fits in the RLHF arc, prerequisites, and learning outcomes."
