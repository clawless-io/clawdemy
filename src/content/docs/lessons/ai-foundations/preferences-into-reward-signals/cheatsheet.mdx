---
title: "Preferences into reward signals: cheatsheet"
description: "One-page reference: why SFT leaves a gap, preference pairs and formats, RLHF's two stages, reward model mechanics, sparse vs dense supervision, and pitfalls."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
