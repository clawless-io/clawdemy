---
title: "Cheatsheet: BERT, part two: pretraining objectives and the train-then-fine-tune workflow"
description: "One-page reference for BERT's training: MLM with the 80/10/10 mix, NSP, the two-stage workflow, and the two common fine-tuning patterns. Architecture is in the previous lesson's cheatsheet."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
