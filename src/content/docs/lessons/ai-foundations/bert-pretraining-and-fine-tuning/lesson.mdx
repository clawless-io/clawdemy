---
title: "BERT, part two: pretraining and fine-tuning"
description: "How BERT is trained: MLM with the 80/10/10 masking mix, NSP, the two-stage pretrain-then-fine-tune workflow, and the CLS vs per-token fine-tuning heads."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
