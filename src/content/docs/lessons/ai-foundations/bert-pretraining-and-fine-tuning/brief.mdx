---
title: "BERT pretraining and fine-tuning, in brief"
description: "Brief for the BERT training lesson: why bidirectionality forced MLM and NSP, the two-stage train-then-fine-tune workflow, and the CLS vs per-token heads."
