---
title: "Cheatsheet: How RLHF and DPO align models"
description: "One-page reference. The reward-to-weight-update gap, why naive maximization fails, PPO's two guardrails, DPO's derivation insight, and the practical PPO-vs-DPO contrast."
sidebar:
  order: 5
  label: Cheatsheet
