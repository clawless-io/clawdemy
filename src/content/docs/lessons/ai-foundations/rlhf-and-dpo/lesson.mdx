...
description: "How RLHF aligns models: why naive reward maximization fails, what PPO does (advantage, KL penalty, clipping), and how DPO skips the reward model entirely."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
