...
<AudioPlayer src="https://audio.clawdemy.org/lessons/rlhf-and-dpo-lesson.mp3" approxMinutes={14} />
...
- **Most current frontier LLMs are aligned via some mix of these methods.** When a model card says "aligned with RLHF" or "preference-tuned with DPO," you now know what is being claimed. RLHF was the original; DPO is the modern shortcut. Newer variants (GRPO and others) adapt to specific problems.
