---
title: "RLHF and DPO: brief"
description: "Brief for the RLHF and DPO lesson: what you'll learn, where it fits in Phase 4, prerequisites, and the learning outcomes on PPO, DPO, and reward hacking."
