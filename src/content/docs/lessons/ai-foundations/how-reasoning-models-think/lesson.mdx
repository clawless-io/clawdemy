...
<AudioPlayer src="https://audio.clawdemy.org/lessons/how-reasoning-models-think-lesson.mp3" approxMinutes={13} />
...
This lesson is about what reasoning models actually are, what they are different from, and how to read the claims their model cards make. By the end you will know why "OpenAI o1" or "DeepSeek R1" is a different kind of object than "GPT-4," what "thinking time" means in a chat UI, what AIME and GSM8K and HumanEval and SWE-bench measure, and how to read a Pass@K number without getting confused.
