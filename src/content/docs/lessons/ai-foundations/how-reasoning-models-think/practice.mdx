...
Without knowing both Pass@1 and Pass@10 for both models, you cannot compare apples-to-apples. The 89%-Pass@1 claim is a stronger statement than 97%-Pass@10 because Pass@1 is the more stringent metric. A model that scores 89% Pass@1 likely also scores higher than 97% Pass@10 (Pass@K is monotone in K).
