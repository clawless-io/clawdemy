---
title: "How models inject position into attention: RoPE"
description: "Why most modern LLMs moved position information from the input into the attention computation: T5 relative bias, ALiBi, and the RoPE rotation deep-dive."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
