---
title: "RoPE position embeddings: brief"
description: "Brief for the lesson on how modern LLMs inject position into attention: the input-to-attention shift, T5 relative bias, ALiBi, and the RoPE intuition."
