...
- **[References: How models know word order](/lessons/ai-foundations/how-models-know-word-order/references/)** covers Vaswani et al. 2017 §3.5 (sinusoidal and learned embeddings) and the sinusoidal frequency intuition.
