---
title: "Cheatsheet: How modern models inject position into attention (RoPE)"
description: One-page reference. The structural shift from input-added to attention-injected position, T5 relative bias, ALiBi, and the RoPE deep-dive.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
