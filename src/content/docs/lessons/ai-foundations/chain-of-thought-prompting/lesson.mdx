...
description: "Chain-of-thought prompting asks a model to reason step by step before answering, lifting accuracy on multi-step problems. Covers zero-shot and few-shot CoT."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
