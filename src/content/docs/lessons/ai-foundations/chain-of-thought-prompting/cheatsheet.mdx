---
title: "Chain-of-thought prompting: cheatsheet"
description: "One-page chain-of-thought reference: zero-shot vs few-shot CoT, why it works, self-consistency, the escalation ladder, and the limits of the technique."
sidebar:
  order: 5
  label: Cheatsheet
