...
description: "How token IDs become dense vectors that carry meaning: the words-on-a-map intuition, the embedding lookup table, and king minus man plus woman arithmetic."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
