...
This lesson draws on the applications and retrieval sections of the broader
CME 295 syllabus, which sit later in the course than the architecture-focused
Lecture 1. Clawdemy provides original notes, summaries, and quizzes derived
...
- **["Not what you've signed up for: Compromising Real-World LLM-Integrated Applications with Indirect Prompt Injection"](https://arxiv.org/abs/2302.12173)**, Greshake et al., 2023. The paper that named indirect prompt injection and demonstrated it against deployed systems. Required reading before you build anything that puts a model on top of retrieved or user-supplied text. Linked in lesson 8 too; it is the canonical citation for both lessons.
...
- **Where to go next.** This lesson opens the applications arc of the Stanford POC track. The natural next stop is **agents and tool use**: models that can call functions, use APIs, and chain actions across multiple turns. Check the [tracks index](/tracks/) for the latest published lessons.
