---
title: "How RAG works: grounding a model in your docs"
description: "Retrieval-augmented generation (RAG) from the inside: the five-stage pipeline, the failure mode at each stage, and the indirect prompt injection RAG creates."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
