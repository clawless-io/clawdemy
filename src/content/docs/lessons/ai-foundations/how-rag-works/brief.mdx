---
title: "How RAG works, in brief"
description: "Brief for the RAG lesson: what retrieval-augmented generation is, the pipeline, bi-encoder and cross-encoder retrieval, HyDE, and indirect prompt injection."
