---
title: "How RAG works: cheatsheet"
description: "One-page RAG reference: the two steps, three problems solved, five-stage pipeline, where each stage breaks, RAG vs fine-tuning, indirect prompt injection."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
