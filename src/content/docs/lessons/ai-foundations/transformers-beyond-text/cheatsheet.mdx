---
title: "Transformers beyond text: cheatsheet"
description: "One-page reference: the ViT pipeline, the MoE mechanism, dense-vs-MoE parameter-count math, and other transformer adaptations worth knowing."
sidebar:
  order: 5
  label: Cheatsheet
