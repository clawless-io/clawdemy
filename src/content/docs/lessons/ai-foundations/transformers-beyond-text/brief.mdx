---
title: "Transformers beyond text: brief"
description: "Brief for the lesson on transformer adaptations beyond text: Vision Transformers (ViT) for images and Mixture-of-Experts (MoE) for sparse parameter scaling."
