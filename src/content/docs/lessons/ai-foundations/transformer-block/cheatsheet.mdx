---
title: "Cheatsheet: The transformer block: where everything comes together"
description: One-page reference. The four wrapping pieces, the block diagram, the architecture knobs, the modern variants on each axis, pitfalls, and a glossary.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
