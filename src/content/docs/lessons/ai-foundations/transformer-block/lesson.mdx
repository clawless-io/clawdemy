---
title: "The transformer block: where it comes together"
description: "Walk through the transformer block: the four pieces (position encoding, feed-forward network, residual connections, layer normalization) that wrap attention."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
