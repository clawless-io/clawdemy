---
title: "Cheatsheet: How transformers scale to real-world data: sliding windows and KV-cache savings"
description: "One-page reference. Two distinct efficiency problems, two distinct fixes. Sliding window attention for compute, MHA/MQA/GQA for KV-cache memory."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
