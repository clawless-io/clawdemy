---
title: "Speculative decoding and diffusion LLMs: brief"
description: "Brief for the lesson on alternatives to autoregressive generation: what speculative decoding and diffusion LLMs are, how each works, and when each fits."
