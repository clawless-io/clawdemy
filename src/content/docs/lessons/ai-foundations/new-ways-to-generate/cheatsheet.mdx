---
title: "Cheatsheet: New ways to generate, speculative decoding and diffusion LLMs"
description: "One-page reference. The autoregressive default, speculative decoding mechanism, diffusion-LLM paradigm shift, and when each alternative fits."
sidebar:
  order: 5
  label: Cheatsheet
