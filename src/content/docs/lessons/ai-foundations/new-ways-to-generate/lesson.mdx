---
title: "Speculative decoding and diffusion LLMs"
description: "Alternatives to autoregressive generation: speculative decoding speeds output while preserving its distribution; diffusion LLMs denoise text from all-mask."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
