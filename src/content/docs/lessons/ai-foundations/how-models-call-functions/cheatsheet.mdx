---
title: "Cheatsheet: How models call functions"
description: "One-page reference. The structured-data gap, the three-stage mechanism, what the LLM sees, the two SFT training pairs, and the common failure modes."
sidebar:
  order: 5
  label: Cheatsheet
