...
description: "How function calling lets an LLM act on the world: the three-stage mechanism (pick, run, format), how models are trained for it, and common failure modes."
sidebar:
  order: 2
  label: Lesson
artifact: lesson
