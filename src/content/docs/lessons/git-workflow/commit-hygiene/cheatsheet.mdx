---
title: "Commit hygiene: cheatsheet"
description: "Quick reference for commit-message rules, atomic-commit patterns, Conventional Commits types, and the anti-patterns to avoid."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
