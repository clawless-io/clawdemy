...
<ReadAlongDim
  src="https://audio.clawdemy.org/lessons/commit-hygiene-lesson.mp3"
  slug="commit-hygiene"
...
1. **Skim-readability.** Filtering history by type (running *git log* with a grep filter for the fix type) finds all bug fixes instantly.
