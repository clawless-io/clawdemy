...
description: "Write commit messages that explain the why, keep commits atomic with the staging area, and use Conventional Commits the way professional teams do."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
