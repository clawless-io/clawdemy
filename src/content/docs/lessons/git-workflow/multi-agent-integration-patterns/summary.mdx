...
The lead-stage build (full-system, after all merges) is the most important guardrail. The [Clawless Computer](https://clawless.ai) 2026-06-04 sprint: per-agent tests passed cleanly; the lead-stage build caught ~300 latent breakers. Per-agent tests are necessary but not sufficient.
