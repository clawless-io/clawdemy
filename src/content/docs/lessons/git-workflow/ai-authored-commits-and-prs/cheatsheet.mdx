---
title: "AI-authored commits and PRs: cheatsheet"
description: "Quick reference for AI-attribution trailer conventions, the review-lens checklist for AI code, and worked drill answers for commits and PRs."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
