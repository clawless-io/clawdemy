...
- The Claude Code commit conventions (2026 documentation), the source for the "Generated with [Claude Code]" marker convention used in this lesson. Adopted by the [Clawless Computer](https://clawless.ai) codebase and many other projects.
...
The Clawless Computer commit convention (used across the Clawless Computer codebase) is referenced as a working example of these conventions in production.
