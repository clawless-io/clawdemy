---
title: "AI-authored commits and PRs: brief"
description: "Overview of the lesson on AI-authored commits and PRs: scope, learning outcomes, reading map, and prerequisites for attributing and reviewing AI code."
track: git-workflow
