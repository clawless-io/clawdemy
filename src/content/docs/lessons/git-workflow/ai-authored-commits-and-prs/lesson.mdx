...
<ReadAlongDim
  src="https://audio.clawdemy.org/lessons/ai-authored-commits-and-prs-lesson.mp3"
  slug="ai-authored-commits-and-prs"
...
The HEREDOC form shown above is one way to write multi-line commit messages from the command line. Most editors handle this naturally too (when you run *git commit* with no message flag, your editor opens for the message).
