...
description: "How git workflows shift when an AI agent types the code: the Co-Authored-By trailer, honest attribution, and the review lenses that catch AI-specific bugs."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
