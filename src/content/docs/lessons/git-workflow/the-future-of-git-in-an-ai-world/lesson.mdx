...
**Branches as movable pointers.** A branch is a reference (a pointer) to a commit. It moves forward as you commit. It's just a file in `.git/refs/heads/` containing a SHA. This conceptual model is straightforward and unlikely to change.
