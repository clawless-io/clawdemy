...
description: "A grounded look at how git may evolve as AI authorship becomes routine, which foundations stay stable, and how to stay calm as the tooling shifts under you."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
