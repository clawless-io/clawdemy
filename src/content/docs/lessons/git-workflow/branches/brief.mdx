---
title: "Git branches, in brief"
description: "A learning brief on git branches: what a branch is, why branches are cheap, how HEAD moves, and when to branch versus commit directly."
track: git-workflow
