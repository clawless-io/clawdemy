...
description: "Learn what a git branch really is, a movable pointer to a commit, how to create, switch, list, and delete branches, and why cheap branches power collaboration."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
