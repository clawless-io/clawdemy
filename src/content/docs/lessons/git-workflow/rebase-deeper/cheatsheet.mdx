---
title: "Rebase, deeper: cheatsheet"
description: "Quick reference for interactive rebase: action keywords, the fixup-autosquash flow, force-with-lease, and recovery, plus drill walk-throughs."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
