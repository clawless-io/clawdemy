...
description: "How specific commits become formal releases: git tags, lightweight vs annotated, semantic versioning, release notes, and releases across team workflows."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
...
<ReadAlongDim
  src="https://audio.clawdemy.org/lessons/releases-and-tags-lesson.mp3"
