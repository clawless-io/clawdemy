---
title: "Releases and tags: cheatsheet"
description: "Quick reference for git tag commands, the semver bump decision rule, release notes structure, and pre-release naming, with a worked semver drill."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
