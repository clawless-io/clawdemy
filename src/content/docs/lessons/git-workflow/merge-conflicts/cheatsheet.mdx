---
title: "Merge conflicts: cheatsheet"
description: "Quick reference for resolving git merge conflicts: the six-step process, marker anatomy, the five conflict types, abort command, and prevention tips."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
