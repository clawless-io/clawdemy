---
title: "Merge conflicts: brief"
description: "Overview of the merge conflict lesson: five core ideas, prerequisites, a three-pass reading map, and what the lesson covers and skips."
track: git-workflow
