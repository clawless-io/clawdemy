...
**Pass 2: The worked examples.** Six concrete scenarios across textual, logical, rename, delete-modify, semantic, and rename-edit conflicts. After this, you've seen most of the conflict types you'll encounter.
