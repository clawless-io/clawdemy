...
description: "Git worktrees give you separate working directories on the same repo, so multiple branches and AI agents can run side by side without interfering."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
