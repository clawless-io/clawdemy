...
description: "How version control solves lost-work problems, and the snapshot mental model behind git that makes every later commit, branch, and merge command coherent."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
