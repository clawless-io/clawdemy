---
title: "Why git exists: brief"
description: "Brief for the git foundations lesson: the two load-bearing ideas, learning outcomes, prerequisites, and what the lesson deliberately defers to later."
track: git-workflow
phase: foundations
phase_order: 1
order: 1
