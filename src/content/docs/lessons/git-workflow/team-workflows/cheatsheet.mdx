---
title: "Git team workflows: cheatsheet"
description: "Quick reference for the four git team workflows, branch protection rules, CI gates, the decision rule and flowchart, plus drill walk-throughs."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
