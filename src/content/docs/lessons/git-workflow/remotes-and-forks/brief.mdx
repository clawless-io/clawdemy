---
title: "Remotes and forks: brief"
description: "Overview of the remotes lesson: the four load-bearing ideas, a three-pass reading map, prerequisites, and what it does and does not cover."
track: git-workflow
