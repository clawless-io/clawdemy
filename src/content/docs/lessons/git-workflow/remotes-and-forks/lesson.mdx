...
description: "How branches travel between machines: remotes, push, fetch, pull, origin versus upstream, the fork-based contribution model, and safe force-pushing."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
