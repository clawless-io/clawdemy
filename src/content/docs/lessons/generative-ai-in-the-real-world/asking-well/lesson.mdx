...
<ReadAlongDim
  src="https://audio.clawdemy.org/lessons/asking-well-lesson.mp3"
  slug="asking-well"
...
This lesson's practice, in [Clawless](https://clawless.ai), runs the whole loop on your real task: build a three-part prompt around it, generate options, then rehearse the conversation you would most like a private run at.
