...
description: "A self-check on prompt anatomy, a Clawless Computer session that builds a real prompt, generates options, and rehearses a conversation, plus flashcards."
artifact: practice
sidebar:
  order: 3
  label: Practice
...
The lesson asked you to keep a real task from your own week open. This practice runs the full loop on it. Open [Clawless Computer](https://clawless.ai), the working environment we use across Clawdemy, and start a new conversation.
