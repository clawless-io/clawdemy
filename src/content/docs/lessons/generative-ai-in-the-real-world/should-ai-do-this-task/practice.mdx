...
description: "Check yourself on the two filters, then screen your own task through all eight questions in Clawless Computer with a skeptical interviewer, plus flashcards."
artifact: practice
sidebar:
  order: 3
  label: Practice
