...
description: "Check yourself on the method, then run a real project end to end in Clawless: two tailored pieces, one judgment call, and turn by turn interview rehearsal."
artifact: practice
sidebar:
  order: 3
  label: Practice
