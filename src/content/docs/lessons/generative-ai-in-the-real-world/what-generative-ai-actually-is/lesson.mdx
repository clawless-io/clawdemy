...
Along the way you will not just read. Each lesson comes with practice you can run yourself in [Clawless](https://clawless.ai), the working environment we use across Clawdemy, so every idea gets tested against a real, live model. This lesson's practice is the gentlest of the whole set: your first structured conversation with a model, just to watch the prediction machine work. Understanding you have used sticks. Understanding you have only read about evaporates.
