...
description: "Check yourself on the four-part map, then work two exercises in Clawless Computer: sort plain scenarios onto the map and watch a model's safety behavior."
artifact: practice
sidebar:
  order: 3
  label: Practice
...
Two exercises. The first is a sorting drill you can do on paper. The second runs in [Clawless Computer](https://clawless.ai), the working environment we use across Clawdemy, and a plain conversation is all it needs.
...
The goal is not to defeat the safety behavior. It is to see it working and feel where its edges are, because a tool you have watched hedge and refuse is a tool you will trust more accurately. In Clawless Computer, ask a current model some questions it should answer plainly, some it should refuse, and some where the honest answer is that it is not sure, and watch how it behaves.
