---
title: "Cheatsheet: The handwritten-digit problem"
description: One-page reference. Why a digit is hard for a computer, why rule-writing fails, why handwritten digits are the classic first problem, the rule-vs-examples shift, conceptual pitfalls, and the vocabulary to use precisely.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
