---
title: "Lesson: The handwritten-digit problem"
description: "Recognizing a messy handwritten 3 is effortless for you and brutally hard to write as a computer program. This lesson shows why rule-writing fails, why handwritten digits are the classic first problem in machine learning, and the paradigm shift that makes neural networks (and most of modern AI) work: stop writing rules, start showing examples."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
