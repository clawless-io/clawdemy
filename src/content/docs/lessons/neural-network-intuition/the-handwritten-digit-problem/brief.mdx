---
title: "The handwritten-digit problem: brief"
description: "Overview of the handwritten-digit lesson: what you'll learn, where it fits in the track, prerequisites (none), and the read and practice time."
