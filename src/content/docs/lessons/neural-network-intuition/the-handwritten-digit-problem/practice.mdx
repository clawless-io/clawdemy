...
A grid of pixels, where each pixel is just a number for how dark that little square is. A common setup is 28 by 28, which is 784 brightness numbers and nothing else. There are no curves, loops, or shapes in there. Only the list of numbers.
...
A grid of pixels, each one a number for how dark that square is. A 28 by 28 image is 784 brightness numbers, with no shapes or curves anywhere inside.
