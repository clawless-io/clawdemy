---
title: "The cost landscape: brief"
description: "Overview of the cost landscape: the gradient, the negative gradient as the downhill compass, worked one and two-knob steps, and the local minimum caveat."
