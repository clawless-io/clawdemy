---
title: "The cost landscape: cheatsheet"
description: "Cost landscape on one page: terrain, slopes and the gradient, worked downhill steps in 1D and 2D, local vs global minima, pitfalls, and key vocabulary."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
