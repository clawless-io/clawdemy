...
description: "Picture a neural network's cost as a landscape of hills and valleys, meet the gradient that points steepest uphill, and step against it to lower the cost."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
