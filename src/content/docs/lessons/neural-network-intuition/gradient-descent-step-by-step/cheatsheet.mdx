---
title: "Cheatsheet: Gradient descent, step by step"
description: One-page reference. The update rule, the learning rate tradeoff, the training loop, worked runs (converge, diverge, crawl), what gradient descent does not do, pitfalls, and precise vocabulary.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
