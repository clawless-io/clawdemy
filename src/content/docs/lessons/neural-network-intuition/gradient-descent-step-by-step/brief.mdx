---
title: "Gradient descent: brief"
description: "A brief on gradient descent: the update rule, learning rate tradeoffs, the training loop, stochastic gradient descent, and what backpropagation will explain."
