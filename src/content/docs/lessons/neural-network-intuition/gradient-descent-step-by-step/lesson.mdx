...
description: "Learn the gradient descent update rule, run it by hand to watch the cost fall, and see how the learning rate makes training converge, diverge, or crawl."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
