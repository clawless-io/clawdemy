---
title: "Cheatsheet: Weights, biases, and the squish"
description: One-page reference. The one neuron formula, what weights and biases do, sigmoid vs ReLU, a worked neuron computation both ways, the parameter count, pitfalls, and precise vocabulary.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
