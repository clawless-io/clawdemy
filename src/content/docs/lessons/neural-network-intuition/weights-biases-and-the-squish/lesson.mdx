...
description: "Every neuron runs one computation: multiply each input by a weight, add a bias, then squash with sigmoid or ReLU. Work it by hand and count the parameters."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
