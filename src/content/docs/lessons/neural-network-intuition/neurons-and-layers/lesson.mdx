---
title: "Neurons as numbers, layers as structure"
description: "Open up the neural network: a neuron is just a container holding one number between 0 and 1, arranged in input, hidden, and output layers that feed forward."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
