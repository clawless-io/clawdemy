---
title: "Cheatsheet: Neurons as numbers, layers as structure"
description: One-page reference. What a neuron is, the input and output layers, hidden layers, feedforward flow, worked numbers (pixel trace, output read, neuron count), pitfalls, and precise vocabulary.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
