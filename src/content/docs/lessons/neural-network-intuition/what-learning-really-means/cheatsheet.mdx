---
title: "What learning really means: cheatsheet"
description: "Quick reference for the cost function: the recipe, worked good vs bad costs, the C(w, b) reframe, learning as minimizing, and the pitfalls to dodge."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
