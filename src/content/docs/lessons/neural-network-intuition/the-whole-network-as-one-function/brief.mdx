---
title: "The whole network as one function: brief"
description: "A neural network as one function: brief overview of the forward pass, the f(x; w, b) split, and why parameter values, not structure, drive all behavior."
