---
title: "Cheatsheet: Seeing it whole, and where next"
description: One-page reference. The whole track in one chain, the training loop, one step start to finish, the one picture to keep, what was deferred, and where to go next.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
