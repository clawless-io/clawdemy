...
description: "Backpropagation is the chain rule applied through a network's layers. Work the smallest chain by hand, and see why running it backward is the efficient way."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
