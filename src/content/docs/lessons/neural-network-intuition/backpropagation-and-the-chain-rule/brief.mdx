---
title: "Backpropagation, in brief"
description: "Backpropagation as the chain rule: a brief preview with learning outcomes, prerequisites, the worked chain, and where the vanishing gradient comes from."
