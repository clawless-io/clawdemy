...
description: "One-page reference for backpropagation as the chain rule: the one-line rule, a worked chain by hand, why running it backward reuses work, and key pitfalls."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
