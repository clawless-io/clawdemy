---
title: "Backpropagation: cheatsheet"
description: "One-page backpropagation reference: why brute force fails, the wish-based intuition, the backward sweep, the training loop, the averaging effect, and pitfalls."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
