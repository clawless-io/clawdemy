---
title: "What backpropagation is really doing"
description: "The intuition behind backpropagation, no calculus: follow what each output neuron wants, watch those wishes ripple backward, and one sweep yields the gradient."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
