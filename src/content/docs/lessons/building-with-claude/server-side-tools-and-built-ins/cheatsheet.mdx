---
title: "Server-side tools and built-ins: cheatsheet"
description: "One-page reference: the three tool categories, per-tool decisions, pricing, the server-tool response shape, and the computer-use discipline."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
