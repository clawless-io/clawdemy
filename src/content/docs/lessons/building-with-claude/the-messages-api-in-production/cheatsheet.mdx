---
title: "Messages API in production: cheatsheet"
description: "One-page reference: streaming snippets, the HTTP error map, retry policy, request size limits, batches numbers, and the request_id logging habit."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
