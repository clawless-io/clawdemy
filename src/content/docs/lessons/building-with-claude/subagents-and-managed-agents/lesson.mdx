...
description: "Subagents spawn focused inner loops with isolated context and per-subagent tools; Claude Managed Agents is the hosted harness for long-running async work."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
