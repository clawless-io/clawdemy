---
title: "Subagents and Claude Managed Agents: cheatsheet"
description: "One-page reference: Subagent fields and benefits, what subagents inherit, Managed Agents concepts, the five-step flow, and the decision frame."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
