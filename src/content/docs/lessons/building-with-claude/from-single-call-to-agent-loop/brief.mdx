---
title: "Single call to agent loop, in brief"
description: "Roadmap for the agent-loop lesson: the workflow-vs-agent distinction, the 30-line loop, the stop_reason vocabulary, tool_choice modes, and loop disciplines."
