...
description: "Turn a single Claude call into a multi-turn agent loop: the workflow-vs-agent distinction, the canonical loop, stop_reason dispatch, and tool_choice steering."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
