---
title: "Single call to agent loop: cheatsheet"
description: "One-page agent-loop reference: workflow vs agent, the 30-line loop, the full stop_reason dispatch, tool_choice steering, and the four loop disciplines."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
