---
title: "Cheatsheet: Prompt caching and context management"
description: One-page reference. cache_control mechanics, pricing multipliers, usage fields, the context-window picture, compaction, context editing, and the cost-vs-staleness frame.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
