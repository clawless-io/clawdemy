---
title: "Cheatsheet: Agent Skills and Claude Code"
description: One-page reference. Skill on-disk shape, frontmatter rules, progressive disclosure, the three surfaces, Claude Code essentials, Skills + Claude Code composition for the L9 patterns.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
