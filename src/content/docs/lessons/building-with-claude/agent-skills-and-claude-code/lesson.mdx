...
description: "Learn what Agent Skills are: on-disk packages Claude reads on demand, progressive disclosure, the three surfaces, and how Claude Code makes prompts durable."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
