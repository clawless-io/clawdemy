---
title: "Tool use: cheatsheet"
description: "Quick reference for Claude tool use: tool definition shape, the four-step loop, ordering rules, tool_choice, parallel calls, error handling, and token cost."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
