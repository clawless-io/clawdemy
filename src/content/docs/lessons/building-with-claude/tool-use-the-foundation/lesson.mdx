...
{/* COMPONENT PLACEHOLDER (Lead wires at promotion): <SourceLecture url="https://platform.claude.com/docs/en/agents-and-tools/tool-use/overview" title="Anthropic Academy 'Building with the Claude API' (tools sections) + Anthropic public Tool use docs" instructor="Anthropic" /> */}
