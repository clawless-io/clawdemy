---
title: "Tool use, the foundation"
description: "How to let Claude call your functions: define a tool (name, description, input_schema), run the four-step request-response loop, and handle errors."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
