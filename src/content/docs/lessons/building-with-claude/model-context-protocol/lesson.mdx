...
{/* COMPONENT PLACEHOLDER (Lead wires at promotion): <SourceLecture url="https://platform.claude.com/docs/en/agents-and-tools/mcp-connector" title="Anthropic Academy 'Introduction to Model Context Protocol' + 'MCP Advanced Topics' + Anthropic public MCP connector docs + modelcontextprotocol.io spec" instructor="Anthropic" /> */}
