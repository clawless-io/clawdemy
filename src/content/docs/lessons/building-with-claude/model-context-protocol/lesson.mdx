...
description: "Learn what Model Context Protocol (MCP) is, the open standard for connecting AI apps to external systems, and how Claude's connector calls remote MCP servers."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
