---
title: "Cheatsheet: Model Context Protocol"
description: One-page reference. What MCP is, the connector request shape, per-tool configuration, response blocks, decision frame, and the connector's limits.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
