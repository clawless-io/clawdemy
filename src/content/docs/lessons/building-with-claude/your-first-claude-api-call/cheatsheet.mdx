---
title: "Your first Claude API call: cheatsheet"
description: "One-page Claude API reference: endpoint, headers, request body, response shape, stop reasons, and the common first-call pitfalls."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
