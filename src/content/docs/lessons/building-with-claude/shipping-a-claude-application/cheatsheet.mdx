---
title: "Shipping a Claude application: cheatsheet"
description: "Quick reference for shipping a Claude app: the five disciplines, per-call logging, Usage and Cost Admin API, deprecation policy, and the rollout checklist."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
