...
{/* COMPONENT PLACEHOLDER (Lead wires at promotion): <SourceLecture url="https://platform.claude.com/docs/en/about-claude/models/overview" title="Anthropic public Claude docs: Models overview, Extended thinking, Effort, Adaptive thinking" instructor="Anthropic" /> */}
...
- **For pre-4.6 models and for production stability across model patches generally:** use the date-suffixed form (claude-haiku-4-5-20251001, claude-sonnet-4-5-20250929). Behavior pinned; surprise patches do not happen.
...
**Using the alias in production on pre-4.6 models.** claude-haiku-4-5 is an alias; the patch surface lives behind it. Pin to the date-suffixed form (claude-haiku-4-5-20251001) in production. (The 4.6 generation and later need no date suffix; the dateless ID is already pinned.)
...
- **Model IDs:** the 4.6 generation and later are dateless and already pinned (claude-opus-4-8, claude-opus-4-7, claude-sonnet-4-6). Pre-4.6 models use the date-suffixed form for production stability (claude-haiku-4-5-20251001); the dateless alias is for development.
