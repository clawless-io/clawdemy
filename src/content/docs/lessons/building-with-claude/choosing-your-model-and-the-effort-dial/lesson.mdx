...
description: "How to pick the right Claude model (Opus, Sonnet, Haiku) plus the effort dial and thinking modes, with a worked cost example so the trade is concrete."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
