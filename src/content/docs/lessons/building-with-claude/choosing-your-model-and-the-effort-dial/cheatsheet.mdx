---
title: "Model and effort dial: cheatsheet"
description: "Model and effort dial quick reference: family table, default-pick rule, model-ID convention, effort values, thinking modes, and the cost shape."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
