---
title: "Six effective-agent patterns: brief"
description: "What this lesson covers: the six agent patterns, their verbatim definitions, learning outcomes, prerequisites, and the decision tree for picking the right one."
