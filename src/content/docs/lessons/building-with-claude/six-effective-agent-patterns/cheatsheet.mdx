---
title: "Cheatsheet: Six effective-agent patterns"
description: One-page reference. The taxonomy, per-pattern verbatim definitions and when-to-use, the parallelization sub-types, the orchestrator-vs-parallelization distinction, the four-question decision tree, and the cross-pattern principle.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
