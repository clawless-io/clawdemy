...
This lesson is about that turn: from deciding one move at a time to deciding the shape of the whole job first. By the end you will be able to describe how an agent decomposes a goal into an ordered set of sub-tasks, and how it revises that plan when the work does not go as expected.
