...
description: "How an AI agent decomposes a goal into ordered sub-tasks, executes the plan step by step, replans when reality shifts, and picks the right step grain size."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
