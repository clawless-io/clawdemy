---
title: "Planning: breaking a goal, in brief"
description: "An overview of agent planning: why reactive agents fail at scale, decomposition into ordered sub-tasks, plan-then-execute versus replanning, and grain size."
