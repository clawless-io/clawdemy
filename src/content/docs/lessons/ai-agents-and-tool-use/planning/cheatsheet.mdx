---
title: 'Cheatsheet: Planning: breaking a goal into steps'
description: One-page reference. The planning turn, why reaction breaks down, decomposition, structured plans, plan-then-execute vs replanning, a worked example, and when planning is worth it.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
