---
title: "Agentic RAG: cheatsheet"
description: "Quick reference on classical versus agentic RAG: the fixed pipeline, the agentic turn, self-correcting retrieval, the cost, and how it reuses earlier pieces."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
