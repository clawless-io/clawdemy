---
title: "Agentic RAG, in brief"
description: "Overview of agentic RAG: how making retrieval a tool the agent decides to call turns the fixed retrieve-read-answer pipeline into a reasoning loop."
