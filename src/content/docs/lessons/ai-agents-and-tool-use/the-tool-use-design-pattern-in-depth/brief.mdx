---
title: "Tool-use design pattern, in brief"
description: "An overview of writing tool definitions an AI agent can use reliably: the four parts, when-to-use and negative guidance, and disambiguating overlapping tools."
