---
title: "Tool-use design pattern: cheatsheet"
description: "One-page reference on tool definitions: the four parts, bad-vs-good descriptions, parameter rules, negative guidance, disambiguation, and pitfalls."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
