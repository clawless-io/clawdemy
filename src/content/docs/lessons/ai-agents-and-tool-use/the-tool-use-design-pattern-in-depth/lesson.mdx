...
description: "Get an AI agent to call the right tool by writing clear tool definitions, since the model picks tools and fills arguments from your descriptions alone."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
