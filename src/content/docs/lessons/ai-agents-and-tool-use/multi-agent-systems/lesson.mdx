...
description: "Multi-agent systems split work across specialized agents that coordinate. Learn when that helps, when it adds overhead, and why one generalist often wins."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
