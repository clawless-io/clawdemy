---
title: "Multi-agent systems, in brief"
description: "Overview of the multi-agent systems lesson: what it covers, prerequisites, learning outcomes, and how it fits after planning in the agent design track."
