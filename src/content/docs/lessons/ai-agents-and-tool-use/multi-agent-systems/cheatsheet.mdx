...
description: "Quick reference on multi-agent systems: what they are, the advantages, the coordination cost, the fit-not-ranking question, compound systems, and pitfalls."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
