---
title: "What makes an AI an 'agent': cheatsheet"
description: "Quick reference for AI agents: the definition, perceive-decide-act loop, four-part anatomy, chatbot contrast, history, when to use one, and pitfalls."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
