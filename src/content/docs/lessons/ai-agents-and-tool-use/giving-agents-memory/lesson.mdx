...
description: "Agents forget you the moment they answer unless you design memory in. Separates short-term context from persistent memory, then what is worth keeping."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
