---
title: 'Cheatsheet: Giving agents memory'
description: One-page reference. The two kinds of agent memory, the with/without-memory contrast, what to retain vs discard, how the two work together, and pitfalls.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
