...
- **[Anthropic: Build with Claude (context and prompting)](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/overview)**. Practical guidance on what to put in a model's context, which is the short-term half of this lesson: getting the right information into a single run.
