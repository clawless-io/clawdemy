...
description: "How agents get attacked: prompt injection hijacking the goal, tool abuse, and data exfiltration, the defense-in-depth toolkit, and why no defense is airtight."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
