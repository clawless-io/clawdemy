---
title: "Securing agents, in brief"
description: "Overview of agent security: the threat model, three attack categories and defenses, the defense-in-depth toolkit, and the Agents Rule of Two."
