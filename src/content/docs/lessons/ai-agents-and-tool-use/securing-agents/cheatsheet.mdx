---
title: "Securing agents: cheatsheet"
description: "Quick reference for agent security: the structural fact behind prompt injection, the three attacks and defenses, the defense-in-depth toolkit, and pitfalls."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
