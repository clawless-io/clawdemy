...
That is the whole mechanism. Steps 2 through 4 are exactly the decide-act-observe moves from Lesson 1's loop (decide what to do next, take that action, observe the result), seen up close.
