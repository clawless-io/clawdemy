...
description: "Decide whether to hand-roll the agent loop or adopt a framework, then match a framework to your task by category and fit instead of by popularity."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
