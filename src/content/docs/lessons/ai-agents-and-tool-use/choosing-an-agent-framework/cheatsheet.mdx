---
title: "Choosing an agent framework: cheatsheet"
description: "One-page reference: the hand-roll-vs-framework decision, what a framework provides, the landscape by category, a task-to-category map, and the fit rule."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
