...
- **[AutoGen](https://github.com/microsoft/autogen)** (orchestration / multi-agent). Microsoft's framework for coordinating one or more agents and multi-agent conversations.
