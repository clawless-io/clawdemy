---
title: "Agents that self-check: cheatsheet"
description: "One-page reference on agent self-checks: reflection as the cheap reliability move, why first drafts are flawed, honest limits of a second look, and pitfalls."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
