...
| --- | --- | --- |
| L2 | Tool call failed | read error, retry |
| L6 | Weak retrieval | judge insufficient, re-search |
| L7 | Step contradicts plan | replan |
| L9 | (none needed) | proactive check-my-work step |
