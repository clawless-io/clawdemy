...
**Why this order.** The track's working theme this week is configuration as a product: it has users, releases, and bugs. A decision committed to the repository outlives the person who made it. That is what makes an architect's judgment durable.
