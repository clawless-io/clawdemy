...
- **Validation-and-retry loops** work when the retry message carries the specific error ("line items sum to 4,120.00 but the total says 4,210.00, re-read and correct"). Reading errors, transposed digits, and swapped fields fix in one round trip because the answer exists in the source.
