...
description: "The 5-minute scan: what a subagent inherits from its parent, how to cut work without gaps, when to parallelize, and how failures and sources travel."
sidebar:
  order: 4
  label: Summary
artifact: summary
