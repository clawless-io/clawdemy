...
- **"Escalate when unsure" is a blank cheque.** It delegates the escalation decision to the exact component whose judgment you were worried about, and it can never be audited because there is nothing to check it against.
