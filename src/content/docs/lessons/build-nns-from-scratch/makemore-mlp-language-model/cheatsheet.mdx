---
title: "MLP language model: cheatsheet"
description: "MLP language model reference: why counting fails on context, learned embeddings, the architecture end to end, training wrinkles, and a parameter count."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
