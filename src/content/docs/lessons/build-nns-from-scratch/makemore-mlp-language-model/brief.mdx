---
title: "MLP language model: brief"
description: "Overview of the MLP language model lesson: why counting more context fails, how learned embeddings fix it, prerequisites, and what you will be able to do."
