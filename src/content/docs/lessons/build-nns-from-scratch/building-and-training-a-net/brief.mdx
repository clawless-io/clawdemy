---
title: "Building and training a net: brief"
description: "Brief and prerequisites for building and training a neural network: neurons, layers, an MLP, the loss, gradient descent, and the four-step training loop."
