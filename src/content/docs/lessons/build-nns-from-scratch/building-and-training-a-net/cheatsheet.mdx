---
title: "Building and training a net: cheatsheet"
description: "Training a neural network at a glance: the neuron, layer, and MLP structure, the loss, the gradient-descent update, the four-step loop, and a worked step."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
