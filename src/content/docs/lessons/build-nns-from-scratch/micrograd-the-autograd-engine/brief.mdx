---
title: "Autograd engine, micrograd: brief"
description: "A roadmap to the autograd engine lesson: what micrograd is, the three core ideas (computational graph, local derivatives, backpropagation), and what comes next."
