---
title: "Cheatsheet: Building an autograd engine: micrograd"
description: One-page reference. The Value object, local derivatives per operation, the backpropagation recipe, and a worked backward pass.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
