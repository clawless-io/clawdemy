---
title: "Lesson: Building an autograd engine: micrograd"
description: "A neural network learns by nudging its parameters to lower a loss, and to do that it needs the gradient of the loss with respect to every parameter. This lesson builds the engine that computes those gradients automatically, micrograd, in your head: a computational graph, a local derivative per operation, and backpropagation walking the chain rule backward through it."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
