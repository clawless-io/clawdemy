---
title: "Cheatsheet: self-attention from scratch"
description: One-page reference. Why tokens must communicate causally, the crude average, query/key/value attention, the causal mask, and a worked step.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
