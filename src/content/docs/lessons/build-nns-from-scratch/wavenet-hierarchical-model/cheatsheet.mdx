---
title: "WaveNet hierarchical model: cheatsheet"
description: "Quick reference to the WaveNet hierarchy: the flat MLP's crude fusion, the tree of small fusions, receptive-field doubling, and why depth is the point."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
