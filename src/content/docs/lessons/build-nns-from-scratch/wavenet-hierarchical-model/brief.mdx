---
title: "WaveNet hierarchical model, in brief"
description: "Overview, prerequisites, and learning goals for the WaveNet hierarchy lesson: fusing context two groups at a time so depth, not width, gives the model reach."
