...
description: "Backpropagate softmax and cross-entropy by hand and reach the clean result that the gradient on the logits is the predicted probabilities minus the true label."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
