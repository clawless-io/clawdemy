---
title: "Cheatsheet: becoming a backprop ninja"
description: One-page reference. What by-hand backprop is, the softmax-plus-cross-entropy gradient, a worked derivation, the sanity checks, and the local derivatives you need.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
