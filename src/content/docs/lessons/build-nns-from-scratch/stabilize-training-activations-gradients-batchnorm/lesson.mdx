---
title: "Why deep nets won't train: BatchNorm and init"
description: "Deep networks fail to train in two ways: a confidently wrong start and saturated neurons. Fix both with scaled weight initialization and batch normalization."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
