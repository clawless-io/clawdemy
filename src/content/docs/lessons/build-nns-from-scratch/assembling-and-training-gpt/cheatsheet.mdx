---
title: "Cheatsheet: assembling and training the full GPT"
description: One-page reference. Multi-head attention, the transformer block, residuals and layer norm, positional embeddings, the full GPT, and training.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
