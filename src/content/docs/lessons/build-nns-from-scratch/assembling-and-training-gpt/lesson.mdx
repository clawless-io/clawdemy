...
description: "Assemble self-attention into a full GPT: multi-head attention, the transformer block, residuals, layer norm, positional embeddings, next-token training."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
