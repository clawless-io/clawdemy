...
description: "Build the GPT tokenizer from scratch: byte-pair encoding that merges common character pairs into tokens, turning text into the IDs a GPT reads and back."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
