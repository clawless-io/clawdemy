---
title: "Q-learning: cheatsheet"
description: "One-page reference: the Q-learning update beside SARSA, a worked five-step trace, off-policy with epsilon-greedy exploration, and the DQN deadly-triad fixes."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
