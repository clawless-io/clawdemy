...
description: "One-page reference. The Q-learning update side-by-side with SARSA, the worked 5-step A/B trace, the off-policy property, the epsilon-greedy exploration requirement, the DQN bridge with deadly-triad fixes, and terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
