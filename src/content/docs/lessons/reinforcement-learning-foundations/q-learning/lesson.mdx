...
description: "Q-learning estimates optimal action values, then acts greedily. Covers its max-over-actions TD update, off-policy vs SARSA, and why exploration matters."
