...
- On the A/B MDP at alpha = 0.5, gamma = 0.9, five hand-traced Q-learning steps from Q = 0 give Q = (0.975, 0, 0.05125, 1.225); the greedy policy is already **pi^* = (A: stay, B: switch)** even though the Q values have not converged to Q^* = (10, 9.9, 8.9, 11).
