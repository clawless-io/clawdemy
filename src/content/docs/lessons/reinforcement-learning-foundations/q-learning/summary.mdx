...
- **Worked: 5 Q-learning steps on the H/S MDP** (alpha = 0.5, gamma = 0.9, Q_0 = 0). After five updates Q = (0.975, 0, 0.05125, 1.225); the greedy policy is **pi^* = (A: stay, B: switch)** even though Q is nowhere near Q^* = (10, 9.9, 8.9, 11). The policy stabilizes long before Q does, the same early-stabilization as value iteration, now in the sample setting.
