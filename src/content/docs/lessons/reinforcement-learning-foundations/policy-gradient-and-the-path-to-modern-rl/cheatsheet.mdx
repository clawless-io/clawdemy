---
title: "Cheatsheet: Policy gradient and the path to modern RL"
description: "One-page reference. The policy-gradient theorem and REINFORCE update, the worked 2-action softmax step, actor-critic and PPO, the RLHF recipe in policy-gradient terms, and terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
