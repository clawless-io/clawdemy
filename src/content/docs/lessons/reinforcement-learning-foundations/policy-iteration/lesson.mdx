...
description: "Policy iteration computes the optimal policy by alternating two steps: evaluate the current policy with the Bellman equation, then improve it greedily."
