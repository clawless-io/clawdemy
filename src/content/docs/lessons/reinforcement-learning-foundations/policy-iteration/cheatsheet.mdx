---
title: "Policy iteration: cheatsheet"
description: "Policy iteration quick reference: the two phases, the four-step loop, the improvement theorem, a worked MDP, the GPI lens, and key terms."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
