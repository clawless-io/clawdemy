---
title: "Policy iteration: brief"
description: "What policy iteration covers: the evaluate-then-improve loop, the improvement theorem, a worked MDP, prerequisites, and where it sits in RL planning."
