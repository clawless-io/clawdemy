...
description: "One-page reference. The VI update, the contraction property and convergence rate, max-vs-sum vs evaluation, the worked H/S sweeps, the GPI placement, and terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
...
## Worked example (H/S, gamma = 0.9, V_0 = (0, 0))
