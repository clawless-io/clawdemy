---
title: "Value iteration: cheatsheet"
description: "Quick reference for value iteration: the update, the contraction and convergence rate, max versus sum, the worked sweeps, GPI placement, and key terms."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
