...
description: "The 5-minute scan version. The Bellman-optimality update sweep, geometric convergence at rate gamma, the greedy-stabilizes-early stopping trick, the worked A/B iterations, and VI as the extreme of GPI that prefigures Q-learning and DQN."
sidebar:
  order: 4
  label: Summary
artifact: summary
