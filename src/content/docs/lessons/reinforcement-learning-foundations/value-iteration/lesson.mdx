...
- Worked on the A/B MDP at gamma = 0.9 starting from V_0 = (0, 0): V_1 = (1, 2), V_2 = (1.9, 2.9), V_3 = (2.71, 3.71), V_4 = (3.439, 4.439), creeping toward V^* = (10, 11) found exactly by policy iteration. The greedy policy is **pi^* = (stay, switch) from iteration 1 on**.
