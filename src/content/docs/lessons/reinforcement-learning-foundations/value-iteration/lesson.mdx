...
description: "Value iteration applies the Bellman optimality equation as one direct sweep per step. See why it converges and why the greedy policy stabilizes early."
