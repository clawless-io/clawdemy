---
title: "Cheatsheet: What reinforcement learning actually is"
description: "One-page reference. The three paradigms, the agent-environment-reward loop, what makes RL harder, the exploration-exploitation dilemma, real systems built on RL, and terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
