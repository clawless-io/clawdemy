...
description: "A map of reinforcement learning fundamentals: how the agent-environment-reward loop works, what makes RL hard, and the exploration-exploitation tension."
