...
description: "Estimate a policy's value model-free: play episodes, average the observed returns, and let the law of large numbers converge. Unbiased but high in variance."
