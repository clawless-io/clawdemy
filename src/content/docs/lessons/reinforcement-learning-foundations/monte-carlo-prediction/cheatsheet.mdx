---
title: "Monte Carlo prediction: cheatsheet"
description: "One-page reference: Monte Carlo prediction in first-visit and every-visit forms, the incremental update, the bias-variance position, and a worked example."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
