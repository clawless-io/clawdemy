---
title: "Monte Carlo prediction, in brief"
description: "Model-free policy evaluation explained: first-visit vs every-visit Monte Carlo, a 3-state worked example, and the unbiased but high-variance trade with TD."
