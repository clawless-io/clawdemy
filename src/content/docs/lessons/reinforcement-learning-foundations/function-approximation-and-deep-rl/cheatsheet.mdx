---
title: "Function approximation: cheatsheet"
description: "One-page reference for deep RL: the squared-TD-error loss, the semi-gradient update, a worked linear-Q step, the deadly triad, and DQN's two fixes."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
