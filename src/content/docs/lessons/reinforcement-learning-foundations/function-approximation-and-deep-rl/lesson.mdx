...
description: "Tables cannot scale to real state spaces. Function approximation swaps in a parameterized Q, and DQN's replay and target network tame the deadly triad."
