---
title: "Temporal-difference learning, in brief"
description: "A brief on temporal-difference learning: the TD(0) update, a worked four-episode chain, the MC vs TD bias-variance tradeoff, and where TD powers modern RL."
