...
True values: the value function under policy pi(A) = 1 + 1 = 2 (two reward-1 steps to terminal), the value function under policy pi(B) = 1, the value function under policy pi(C) = 0. The aim is to see TD converge toward (2, 1, 0).
