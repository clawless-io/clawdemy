...
description: "Temporal-difference learning updates value estimates after every step using a bootstrapped one-step target, cutting variance and enabling online learning."
