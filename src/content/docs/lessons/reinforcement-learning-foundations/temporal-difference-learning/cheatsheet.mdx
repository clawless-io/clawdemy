---
title: "Temporal-difference learning: cheatsheet"
description: "Quick reference for temporal-difference learning: the TD(0) update, TD error, worked chain, MC vs TD bias-variance, the deadly triad, and key terms."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
