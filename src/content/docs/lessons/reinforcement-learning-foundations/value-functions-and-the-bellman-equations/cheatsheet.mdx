---
title: "Value functions and Bellman: cheatsheet"
description: "One-page reference: V and Q definitions, the Bellman expectation and optimality equations side by side, the recursion on a chain, and key terms."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
