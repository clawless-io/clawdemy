---
title: "Cheatsheet: Markov Decision Processes"
description: "One-page reference. The MDP tuple, the Markov property, trajectory and return, the discount factor with worked numbers, state-design caveats, and terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
