...
description: "Lesson 2 of Track 23. Takes the four buckets named in L1 (malicious use, AI race, organizational risks, rogue AIs) and works each in detail with Hendrycks' sub-categories, mechanisms, historical analogies, and intervention surfaces. The lesson's capability is the classify-and-defend move: given a real headline about an AI harm, name the bucket, name the mechanism, name what would change the dial. Practice has six real-ish headlines to sort."
...
{/* COMPONENT PLACEHOLDER (Lead wires at promotion): <SourceLecture url="https://www.aisafetybook.com/textbook/overview-of-catastrophic-ai-risks" title="Introduction to AI Safety, Ethics, and Society, Chapter 1: Catastrophic AI Risks (sections 1.2 through 1.5)" instructor="Dan Hendrycks (Center for AI Safety)" /> */}
