---
title: "Cheatsheet: the four catastrophic risk categories"
description: "Scannable reference table of Hendrycks' four buckets with sub-mechanisms, historical analogies, and intervention levers per bucket. Plus the classify-and-defend three-step protocol and the cross-bucket distinctness rule."
