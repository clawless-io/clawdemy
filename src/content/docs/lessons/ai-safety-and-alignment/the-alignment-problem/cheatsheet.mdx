---
title: "Cheatsheet: the alignment problem"
description: "Scannable reference for L4. Three failure modes with worked toy examples; outer-vs-inner decomposition; the structural reason deceptive alignment is the hardest; the L4 capability four-step protocol; cross-track pointers."
