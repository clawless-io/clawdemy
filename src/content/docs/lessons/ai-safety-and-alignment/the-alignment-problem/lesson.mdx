---
title: "The alignment problem: three failure modes that sit underneath robustness and monitoring"
description: "Lesson 4 of Track 23. Hendrycks Ch 3.4 works the substrate underneath L3: even a perfectly robust and perfectly monitored system can be pursuing the wrong objective. Three named alignment failure modes (specification gaming, proxy gaming, deceptive alignment), each with a worked toy example. The inner-vs-outer alignment frame as the unifying decomposition. Why alignment is the part of the problem that does not go away with more eval and more interpretability."
...
{/* COMPONENT PLACEHOLDER (Lead wires at promotion): <SourceLecture url="https://www.aisafetybook.com/textbook/alignment" title="Introduction to AI Safety, Ethics, and Society, Chapter 3 Section 3.4: Alignment" instructor="Dan Hendrycks (Center for AI Safety)" /> */}
