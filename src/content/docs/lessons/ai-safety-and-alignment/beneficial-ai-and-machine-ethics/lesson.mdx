...
description: "Lesson 7 of Track 23, opener of Phase 3 (ethics and governance). Hendrycks Ch 6 turns from 'what fails' to 'what are we trying to do?' Moral uncertainty as the foundational concept: the field does not have a single correct ethical framework to hand to an AI system. Social welfare functions as the aggregation tools (utilitarian, prioritarian). The moral-parliament approach as a structured response to value heterogeneity. The L7 capability is to explain what moral uncertainty is and why it changes how a designer picks a value-loading approach."
...
{/* COMPONENT PLACEHOLDER (Lead wires at promotion): <SourceLecture url="https://www.aisafetybook.com/textbook/moral-uncertainty" title="Introduction to AI Safety, Ethics, and Society, Chapter 6: Beneficial AI and Machine Ethics" instructor="Dan Hendrycks (Center for AI Safety)" /> */}
