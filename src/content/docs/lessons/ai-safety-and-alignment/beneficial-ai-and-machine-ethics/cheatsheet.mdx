---
title: "Beneficial AI and machine ethics: cheatsheet"
description: "Scannable reference on moral uncertainty: the three strategies with tradeoffs, social welfare functions, cost-benefit blind spots, and fairness criteria."
