...
description: "Opener for the AI Safety and Alignment track. AI safety is the field that asks what fails when AI systems are deployed, who is responsible, and what the discipline knows about preventing harm. This lesson grounds the field in Hendrycks' CAIS textbook: the four-bucket catastrophic-risk typology, the safety-engineering scaffolding the field borrows from older fields, the descriptive register, and why a vocabulary beats a stance. By the end, you can write one paragraph that states what AI safety studies and why it is a discipline rather than a position."
...
{/* COMPONENT PLACEHOLDER (Lead wires at promotion): <SourceLecture url="https://www.aisafetybook.com/textbook/overview-of-catastrophic-ai-risks" title="Introduction to AI Safety, Ethics, and Society, Chapter 1: Overview of Catastrophic AI Risks" instructor="Dan Hendrycks (Center for AI Safety)" /> */}
