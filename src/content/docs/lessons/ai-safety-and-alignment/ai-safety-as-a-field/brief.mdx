---
title: "AI safety as a field: what it studies and why it is a discipline, not a stance"
description: "Opener of Track 23 (AI Safety and Alignment). Frames AI safety as a field with a subject (catastrophic AI risks), a vocabulary (the four-bucket typology, the specification-vs-proxy-gaming distinctions), a method (descriptive, attributed, cross-disciplinary), and a connection to neighboring fields (safety engineering, complex systems, governance). The capability bar is the paragraph-write: state what AI safety studies and why it is a discipline rather than a stance, in roughly 6-8 sentences."
