---
title: "AI governance: cheatsheet"
description: "Scannable reference: the four governance layers with mechanisms, strengths, and limits; compute-governance specifics; and the placement protocol for proposals."
