---
title: "Cheatsheet: collective action and multi-agent dynamics"
description: "Scannable reference for L8. Three collective-action failure modes with strategic structure and AI examples; four cooperation mechanisms with AI-specific failure modes; the cooperation tension; the L8 capability five-part protocol; L2/L7/L8 thread map."
