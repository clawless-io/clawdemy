---
title: "The binomial distribution: brief"
description: "An orientation to the binomial distribution: what you will learn, how it builds on expected value, the math involved, and the time and difficulty to expect."
