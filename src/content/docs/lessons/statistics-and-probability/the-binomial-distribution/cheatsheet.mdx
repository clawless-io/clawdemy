---
title: "Cheatsheet: Counts and trials: the binomial distribution"
description: "One-page reference. The four binomial conditions, the probability formula with worked numbers, the n-times-p expected count, exactly-versus-at-least, the AI connections, and terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
