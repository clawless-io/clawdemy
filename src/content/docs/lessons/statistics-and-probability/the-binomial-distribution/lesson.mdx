...
{/* DIAGRAM PLACEHOLDER: a binomial probability bar chart (for example 5 trials, probability 0.8) showing the probability of each possible number of successes, peaked near the mean of 4 */}
