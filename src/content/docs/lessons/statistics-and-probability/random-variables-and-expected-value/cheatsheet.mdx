---
title: "Cheatsheet: Random variables and expected value"
description: "One-page reference. Random variables, the expected-value formula with worked numbers, variance and standard deviation, the AI connections, and terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
