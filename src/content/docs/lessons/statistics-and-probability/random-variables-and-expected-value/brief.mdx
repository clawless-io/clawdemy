---
title: "Random variables and expected value: brief"
description: "Preview of the random variables and expected value lesson: scope, prerequisites, the arithmetic involved, and how expected value underpins machine learning."
