---
title: "Cheatsheet: Testing a claim: hypothesis testing and p-values"
description: "One-page reference. The null and alternative, the test logic, the p-value definition, the three misreadings, the multiple-testing trap, the AI connections, and terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
