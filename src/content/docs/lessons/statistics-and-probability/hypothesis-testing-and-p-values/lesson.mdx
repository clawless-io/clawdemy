...
description: "How hypothesis testing decides whether an effect is real or noise: the null and alternative, the p-value defined carefully, and the misreadings to refuse."
