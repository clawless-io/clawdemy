---
title: "Hypothesis testing and p-values: brief"
description: "An orientation to the hypothesis testing lesson: the null and alternative, the p-value, prerequisites, and the misreadings that make p so abused."
