...
description: "Bayes' theorem is how to update a belief when evidence arrives. Build it from natural frequencies, re-derive the base-rate result, and see it in spam filters."
