---
title: "Bayes' theorem: cheatsheet"
description: "Quick reference for Bayes' theorem: the formula and its parts, the natural-frequencies method, the base-rate example, updating twice, and key terms."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
