...
{/* DIAGRAM PLACEHOLDER: a skewed distribution (nine salaries clustered at 50k, one outlier at 2M) with the mean pulled far to the right by the outlier and the median sitting at the cluster, showing how the mean is dragged while the median is robust */}
