...
description: "Find a dataset's center (mean, median, mode) and spread (range, variance, standard deviation), why they clash on skew, and standardizing for machine learning."
