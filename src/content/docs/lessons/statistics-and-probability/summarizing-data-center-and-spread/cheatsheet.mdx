---
title: "Summarizing data: cheatsheet"
description: "One-page reference: the three centers and when to use each, the spread measures, the standardization formula, and the terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
