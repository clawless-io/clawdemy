---
title: "Summarizing data, in brief"
description: "An orientation to summarizing data before modeling: the two questions every summary answers, prerequisites, the math involved, and what the lesson covers."
