---
title: "Why AI runs on statistics: cheatsheet"
description: "One-page reference: why AI reasons in probabilities, the forward-versus-backward split, where each idea lives in a real system, and the base-rate example."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
