...
import SpBaseRateGrid from '../../../../../components/illustrations/t9/SpBaseRateGrid.astro';

import LessonFreshness from '../../../../../components/LessonFreshness.astro';
import SourceLecture from '../../../../../components/SourceLecture.astro';

<ReadAlongDim
  src="https://audio.clawdemy.org/lessons/why-ai-runs-on-statistics-lesson.mp3"
  slug="why-ai-runs-on-statistics"
