...
{/* DIAGRAM PLACEHOLDER: a natural-frequency grid of 10,000 people: 100 sick (99 true positives, 1 false negative) and 9,900 healthy (99 false positives, 9,801 true negatives), showing the 99 true vs 99 false positives that make the positive-test probability only 50 percent */}
