---
title: "Why AI runs on statistics: brief"
description: "What the opening statistics-for-AI lesson covers and why it comes first: the probability-statistics split, the track map, prerequisites, and time."
