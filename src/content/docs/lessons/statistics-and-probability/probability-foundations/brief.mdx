---
title: "Probability foundations: brief"
description: "An orientation to the probability lesson: what you will learn, where it fits in the track, prerequisites, and the math and time to expect before you start."
