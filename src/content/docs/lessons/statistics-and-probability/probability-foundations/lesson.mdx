...
description: "What a probability is (a number from 0 to 1) and the three rules for combining them: the complement, addition for OR, and multiplying independent ANDs."
