---
title: "Probability foundations: cheatsheet"
description: "Reference for probability: the 0 to 1 scale, the counting rule, the three rules (complement, addition, multiplication) with worked numbers, and independence."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
