...
{/* DIAGRAM PLACEHOLDER: three small histograms side by side: right-skewed (long tail right, mean above median), left-skewed (tail left), and symmetric (mean equals median), labeling tail direction and mean-vs-median */}
...
{/* DIAGRAM PLACEHOLDER: a bimodal histogram (two peaks) contrasted with the same data under too-few and too-many bins, showing how bin width changes the apparent shape */}
