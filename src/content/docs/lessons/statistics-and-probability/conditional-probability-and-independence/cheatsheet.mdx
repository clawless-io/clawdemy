---
title: "Cheatsheet: When one event tells you about another: conditional probability and independence"
description: "One-page reference. The conditional probability formula, reading a two-way table, the not-the-same-as-the-flip warning, the general multiplication rule, independence as a special case, and terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
