...
description: "Lesson 6 of Track 9. The multiplication rule needed independence, but the events that matter in AI are dependent. This lesson defines conditional probability (the chance of A given B), reads it off a two-way table, generalizes the multiplication rule to dependent events, redefines independence in those terms, and hammers the subject's costliest confusion: the chance of A given B is not the chance of B given A. It sets up Bayes' theorem in the next lesson."
