...
{/* DIAGRAM PLACEHOLDER: a two-way table of 1,000 people split by condition (present/absent) and test (positive/negative), highlighting that the probability of a positive test given the condition (0.80) differs from the probability of the condition given a positive test (0.47) */}
