...
description: "Defines conditional probability (the chance of A given B), reads it off a two-way table, and shows why the chance of A given B is not the chance of B given A."
