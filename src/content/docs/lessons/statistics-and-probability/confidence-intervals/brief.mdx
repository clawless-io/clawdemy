...
description: "Lesson 12 of Track 9. A single measured number hides its uncertainty; a confidence interval shows it, turning '90% accurate' into '90%, give or take 4 points.' This lesson builds the interval as estimate plus or minus a margin of error (about two standard errors for 95%), shows how data and confidence trade off against width, and corrects the interpretation almost everyone gets wrong: a 95% interval is not a 95% probability that the truth is in this particular range."
