---
title: "Cheatsheet: How sure are we? confidence intervals"
description: "One-page reference. The interval formula, the 95% rule of two standard errors, the width tradeoffs, the right and wrong interpretations, the AI connections, and terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
