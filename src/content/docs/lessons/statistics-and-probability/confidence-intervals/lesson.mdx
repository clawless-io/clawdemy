...
<ReadAlongDim
  src="https://audio.clawdemy.org/lessons/confidence-intervals-lesson.mp3"
...
{/* DIAGRAM PLACEHOLDER: twenty confidence intervals from twenty different samples plotted as horizontal bars against a fixed true value, with about one missing it, illustrating that 95 percent of such intervals contain the truth (not a 95 percent chance for any single one) */}
