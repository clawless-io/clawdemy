---
title: "Cheatsheet: The bell curve: the normal distribution"
description: "One-page reference. Continuous probability as area, the normal's two parameters, the 68-95-99.7 rule, the z-score with worked numbers, the AI connections, and terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
