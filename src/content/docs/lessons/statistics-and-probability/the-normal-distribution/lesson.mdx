...
<ReadAlongDim
  src="https://audio.clawdemy.org/lessons/the-normal-distribution-lesson.mp3"
...
{/* DIAGRAM PLACEHOLDER: the normal bell curve with shaded bands at one, two, and three standard deviations from the mean, labeled 68 percent, 95 percent, and 99.7 percent */}
...
{/* DIAGRAM PLACEHOLDER: two bell curves showing standardization: a raw distribution (mean 500, SD 100) mapped onto the standard normal (mean 0, SD 1), with a value at 600 becoming a z-score of +1 */}
