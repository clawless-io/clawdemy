---
title: "From sample to population: central limit theorem"
description: "Sample statistics estimate population parameters with uncertainty. Meet the standard error, the square-root law for sample size, and the central limit theorem."
