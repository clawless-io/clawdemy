...
{/* DIAGRAM PLACEHOLDER: a curve of standard error shrinking as sample size grows, illustrating standard error equals sigma over the square root of n (quadruple n to halve the error) */}
...
{/* DIAGRAM PLACEHOLDER: three sampling distributions of the sample mean for growing sample size (n = 5, 30, 100), each more tightly bell-shaped around the true mean regardless of the skewed population shape */}
