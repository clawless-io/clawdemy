---
title: "Cheatsheet: From sample to population: sampling and the central limit theorem"
description: "One-page reference. Population vs sample, parameter vs statistic, the standard error and square-root law, the central limit theorem, the AI connections, and terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
