---
title: "Cheatsheet: When two things move together: correlation"
description: "One-page reference. The scatterplot, the correlation coefficient and how to read it, the linear-only caveat, the four explanations for any correlation, the ML connections, and terms to use precisely."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
