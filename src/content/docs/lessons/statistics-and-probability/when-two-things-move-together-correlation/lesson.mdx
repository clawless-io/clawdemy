...
description: "Measure how tightly two quantities move together with the correlation coefficient, why it sees only straight lines, and why correlation is not causation."
