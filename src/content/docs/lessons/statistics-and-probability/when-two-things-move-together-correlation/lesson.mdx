...
{/* DIAGRAM PLACEHOLDER: four scatterplots showing a strong positive relationship (coefficient near +0.95), a strong negative one (near -0.9), no relationship (a shapeless cloud near 0), and a weak positive one (near +0.5) */}
...
{/* DIAGRAM PLACEHOLDER: a scatterplot of points tracing a clear U-shape (strong curved relationship) whose linear correlation coefficient is near zero, showing that the coefficient sees only straight lines */}
