---
title: "Statistics in machine learning, in brief"
description: "How the capstone maps statistics tools onto an ML project, tests a model claim with four questions, and bounds where the statistical-thinking layer ends."
