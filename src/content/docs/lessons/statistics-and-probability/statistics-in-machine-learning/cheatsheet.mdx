---
title: "Statistics in machine learning: cheatsheet"
description: "One-page reference: the track's tools mapped to the ML workflow, evaluation as inference, the four questions for a model claim, and the through-line."
sidebar:
  order: 5
  label: Cheatsheet
