---
title: "Cheatsheet: DQN (replay buffer, target network, double Q-learning)"
description: "One-page reference: each DQN engineering trick mapped to the deadly-triad leg it patches, plus the max-overestimation bias numbers."
