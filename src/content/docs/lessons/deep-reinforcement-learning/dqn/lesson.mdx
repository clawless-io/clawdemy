---
title: "DQN: replay buffer, target network, double-Q"
description: "Each of DQN's three tricks patches a leg of the deadly triad: replay buffer for off-policy data, target network for bootstrapping, double Q for max bias."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
