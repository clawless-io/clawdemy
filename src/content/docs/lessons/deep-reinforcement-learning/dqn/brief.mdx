---
title: "Brief: DQN (replay buffer, target network, double Q-learning)"
description: "Editorial brief for Lesson 7 of Track 18 (Deep Reinforcement Learning). Phase 2 lesson 2: each DQN engineering trick mapped to a leg of the deadly triad named in L6. Worked: closed-form max-overestimation bias on a small example."
