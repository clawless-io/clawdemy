---
title: "Cheatsheet: Offline RL algorithms (BCQ, CQL, IQL)"
description: One-page reference. Three algorithms side by side, mechanism, what they train, decision rubric, and the BC sanity check.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
