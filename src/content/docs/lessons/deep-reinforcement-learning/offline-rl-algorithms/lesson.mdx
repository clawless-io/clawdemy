---
title: "Offline RL algorithms (BCQ, CQL, IQL)"
description: "How BCQ, CQL, and IQL keep offline RL stable: constrain actions, penalize out-of-distribution Q-values, or sidestep the max, with a rubric for picking each."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
