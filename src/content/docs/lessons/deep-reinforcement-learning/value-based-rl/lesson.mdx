---
title: "Value-based RL: deriving Q-learning"
description: "Derive Q-learning from the Bellman optimality equation, run tabular Q-iteration on a small MDP, and see why the deadly triad breaks Q-learning convergence."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
