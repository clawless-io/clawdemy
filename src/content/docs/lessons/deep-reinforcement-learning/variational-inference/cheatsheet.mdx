---
title: "Variational inference for RL: cheatsheet"
description: "One-page reference for variational inference in RL: the ELBO, reparameterization trick, Gaussian-to-Gaussian KL, and the two RL applications (Dreamer, SAC)."
