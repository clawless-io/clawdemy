---
title: "Variational inference for RL: brief"
description: "Editorial brief for the variational inference lesson: scope, capability gained, source, and how the ELBO and reparameterization set up control as inference."
