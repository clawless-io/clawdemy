---
title: "Variational inference for RL: the ELBO"
description: "How variational inference powers RL: deriving the ELBO, the reparameterization trick, and where it shows up in world models (Dreamer) and MaxEnt RL (SAC)."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
