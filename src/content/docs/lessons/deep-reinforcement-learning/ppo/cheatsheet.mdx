---
title: "PPO clipped surrogate: cheatsheet"
description: "PPO quick reference: importance-sampled surrogate, TRPO constraint, clipped surrogate, the asymmetric clip behavior, and RLHF integration."
