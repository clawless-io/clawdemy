---
title: "PPO clipped surrogate: brief"
description: "Editorial brief for the PPO lesson: how to derive the clipped surrogate from the on-policy stability problem and frame PPO as the RLHF workhorse."
