---
title: "PPO: the clipped surrogate, RLHF workhorse"
description: "PPO stays near on-policy and clips how far the policy can shift each update, the policy-gradient method behind the RLHF that finetunes language models."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
