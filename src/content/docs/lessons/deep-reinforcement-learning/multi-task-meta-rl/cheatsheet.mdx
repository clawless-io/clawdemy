---
title: "Multi-task RL and meta-RL: cheatsheet"
description: "Quick reference comparing multi-task RL and meta-RL, the three meta-RL families (MAML, RL2, PEARL), a decision rubric, and the foundation-model parallel."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
