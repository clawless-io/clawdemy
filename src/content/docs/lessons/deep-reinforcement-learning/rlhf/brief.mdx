---
title: "RLHF pipeline: brief"
description: "Editorial brief for the RLHF lesson: scope, learning outcomes, source papers, and how the InstructGPT pipeline maps to a variational framework."
