---
title: "RLHF deep-dive: the InstructGPT pipeline"
description: "How RLHF aligns language models to human preferences: the InstructGPT pipeline (SFT, reward model, PPO plus KL penalty), reward hacking, and why beta matters."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
