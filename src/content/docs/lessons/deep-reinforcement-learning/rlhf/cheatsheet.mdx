---
title: "RLHF: cheatsheet"
description: "RLHF quick reference: the three stages, the Bradley-Terry reward objective, the variational optimal policy, beta decision table, operational instruments."
phase: "rl-frontiers"
phase_order: 1
order: 13
