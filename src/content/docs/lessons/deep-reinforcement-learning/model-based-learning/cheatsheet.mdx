---
title: "Cheatsheet: Model-based RL, learning the dynamics"
description: "One-page reference: model classes, least-squares fit, compounding error, Dyna architecture, decision rubric."
