---
title: "Model-based RL: learning the dynamics"
description: "Learn the dynamics in model-based RL: fit a model of the environment for planning and imagined rollouts, gain sample efficiency, and tame compounding error."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
