---
title: "Cheatsheet: RL fundamentals (MDPs, value functions, Bellman)"
description: One-page reference. The MDP tuple, the Markov property, value functions (V, Q, advantage), the Bellman equation, the optimal value, and a worked 2-state MDP.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
