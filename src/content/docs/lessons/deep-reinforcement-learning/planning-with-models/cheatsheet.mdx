---
title: "Cheatsheet: Planning with a learned model"
description: "One-page reference: random shooting, CEM, MPC, MuZero. Each planner mapped to action-space size and problem class."
