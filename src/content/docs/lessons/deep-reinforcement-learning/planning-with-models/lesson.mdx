---
title: "Planning with a learned model: MPC to MuZero"
description: "How to use a learned dynamics model to plan: random shooting, the cross-entropy method (CEM), MPC re-planning every step, and MuZero's MCTS approach."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
