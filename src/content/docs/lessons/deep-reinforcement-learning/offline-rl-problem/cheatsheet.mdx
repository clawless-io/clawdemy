---
title: "Cheatsheet: Offline RL, the problem"
description: One-page reference. Offline vs off-policy vs online distinction; extrapolation error mechanism; two-state worked example numbers; BC bound; fix preview (BCQ / CQL / IQL).
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
