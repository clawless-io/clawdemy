---
title: "Offline RL: brief"
description: "Editorial brief for the offline RL problem lesson: the fixed-dataset setting, the extrapolation-error failure mode, and the BCQ, CQL, IQL fixes to come."
