---
title: "Policy gradients (REINFORCE): brief"
description: "Overview of the REINFORCE lesson: the log-derivative trick, why environment dynamics drop out, a worked sigmoid bandit, and the variance refinements."
