---
title: "Cheatsheet: Policy gradients (REINFORCE)"
description: One-page reference. The log-derivative trick, the REINFORCE estimator, the dynamics-drop-out result, rewards-to-go + baseline refinements, a worked sigmoid bandit with the variance-equals-signal observation, and the bridge to actor-critic.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
