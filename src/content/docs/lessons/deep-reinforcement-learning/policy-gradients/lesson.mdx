...
description: "Derive REINFORCE from the log-derivative trick to improve a neural-network policy from sampled trajectories, no model needed, at the cost of variance."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
