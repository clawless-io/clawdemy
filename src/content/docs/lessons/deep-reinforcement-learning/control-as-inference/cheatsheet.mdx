---
title: "Cheatsheet: Control as inference"
description: "One-page reference: the optimality-conditioned graphical model, soft Bellman backup, soft policy, and the unification of SAC + RLHF + MaxEnt IRL."
