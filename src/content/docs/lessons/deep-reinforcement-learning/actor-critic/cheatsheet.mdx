---
title: "Cheatsheet: Actor-critic methods"
description: One-page reference. The two networks, advantage estimators (MC, TD, n-step, GAE), the training loop, the quantified L4-bandit variance reduction (0.0625 → 0), the bias-variance tradeoff, and what valid baselines look like.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
