...
description: "How actor-critic methods cut REINFORCE's variance: a critic estimates value to supply a baseline or bootstrapped target, trading a little bias for stability."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
