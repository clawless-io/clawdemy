...
description: "Behavioral cloning copies an expert by supervised learning on state-action pairs. See why it is tempting, why small errors compound, and how DAgger fixes it."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
