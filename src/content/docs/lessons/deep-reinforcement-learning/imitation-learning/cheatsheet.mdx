---
title: "Imitation learning: cheatsheet"
description: "Behavioral cloning quick reference: the algorithm, why it appeals, distribution shift, the O(εT²) versus O(εT) bound, DAgger, and where BC works anyway."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
