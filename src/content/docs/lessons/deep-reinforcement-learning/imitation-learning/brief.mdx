---
title: "Imitation learning, in brief"
description: "Overview of behavioral cloning: the algorithm, why it appeals, how distribution shift makes errors compound, DAgger, and where copying an expert suffices."
