---
title: "Deep reinforcement learning, in brief"
description: "Orientation to deep reinforcement learning: the ML regimes, the agent-environment loop, returns, discounting, and what makes the deep variant hard."
