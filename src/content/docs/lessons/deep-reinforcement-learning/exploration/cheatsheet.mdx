---
title: "Exploration strategies: cheatsheet"
description: "Quick reference for RL exploration: three strategy families, the decision rubric, easy-vs-hard distinction, RND mechanism, and common pitfalls."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
