---
title: "Attention and transformers: cheatsheet"
description: "One-page reference on attention and transformers: why recurrence fell short, the core attention idea, the transformer, context-window cost, and pitfalls."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
