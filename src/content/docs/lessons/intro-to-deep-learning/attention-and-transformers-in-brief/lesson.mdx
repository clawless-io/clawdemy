---
title: "Lesson: Attention and transformers, in brief"
description: Recurrence reads a sequence one step at a time, which is slow and forgetful over long distances. This lesson meets the idea that replaced it, attention, which lets every position in a sequence look at every other position at once and weigh what matters. That single idea is the heart of the transformer, the architecture behind modern language models. This is the brief tour; Track 5 goes deep.
artifact: lesson
sidebar:
  order: 2
  label: Lesson
