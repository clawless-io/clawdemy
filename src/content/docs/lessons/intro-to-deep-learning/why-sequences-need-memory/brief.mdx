---
title: "Why sequences need memory: brief"
description: "Overview of why feedforward networks fail at sequences, the recurrent fix with a hidden state, weight reuse, and where simple recurrence strains."
