---
title: "Cheatsheet: Why sequences need memory"
description: One-page reference. What a sequence is, why feedforward nets fail at it, the recurrence fix, how an RNN step works, where simple recurrence struggles, pitfalls, and vocabulary.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
