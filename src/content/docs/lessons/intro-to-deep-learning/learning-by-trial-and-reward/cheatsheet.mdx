---
title: "Cheatsheet: Learning by trial and reward"
description: One-page reference. The RL paradigm shift, the agent-environment-reward loop, RL vs supervised, credit assignment, explore vs exploit, the agent-word note, where RL shines and strains, pitfalls, and vocabulary.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
