---
title: "Reinforcement learning, in brief"
description: "Reinforcement learning: the agent-environment-reward loop, how it differs from supervised learning, plus the credit-assignment and explore-exploit problems."
