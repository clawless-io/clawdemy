---
title: "Lesson: Learning by trial and reward"
description: Every model in this track so far learned from a fixed pile of examples with known answers. This lesson opens the final phase with a different kind of learning entirely. A reinforcement learning agent has no answer key. It acts in an environment, receives rewards or penalties, and learns which actions pay off, the way you learned to ride a bike, by trying and feeling the consequences.
artifact: lesson
sidebar:
  order: 2
  label: Lesson
