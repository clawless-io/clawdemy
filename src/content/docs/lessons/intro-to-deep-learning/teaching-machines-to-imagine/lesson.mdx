...
description: "How generative models flip neural networks from judging to creating, covering the discriminative versus generative split plus VAE and GAN intuition."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
