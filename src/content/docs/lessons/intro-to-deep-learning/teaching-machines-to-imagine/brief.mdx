---
title: "Generative models, in brief"
description: "An orientation to generative models: what the lesson covers, the prerequisites, the learning outcomes, and how the VAE and GAN designs fit together."
