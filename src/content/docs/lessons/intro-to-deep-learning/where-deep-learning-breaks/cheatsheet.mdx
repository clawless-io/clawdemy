---
title: "Cheatsheet: Where deep learning breaks"
description: One-page reference. The four core limitations, each tied to how these systems work, hallucination, why it matters in practice, pitfalls, and vocabulary.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
