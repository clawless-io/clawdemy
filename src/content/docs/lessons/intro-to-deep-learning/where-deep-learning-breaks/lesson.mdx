...
description: "The four core limits of deep learning: data hunger, brittleness, bias from skewed data, and no guarantees, and why each falls out of how these systems work."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
