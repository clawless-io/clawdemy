---
title: "From edges to objects: cheatsheet"
description: "One-page reference on the convolutional hierarchy: a worked recognition trace, receptive field, pooling, the classifier head, CNN uses, and pitfalls."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
