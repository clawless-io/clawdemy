...
description: "How convolutional networks stack into a hierarchy from edges to corners to parts to whole objects, with pooling, a classifier head, and what CNNs do."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
