---
title: "Cheatsheet: Generating by denoising: diffusion"
description: One-page reference. The forward/reverse noise trick, generating from static, why many small steps, how it differs from VAE/GAN, text steering, tradeoffs, pitfalls, and vocabulary.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
