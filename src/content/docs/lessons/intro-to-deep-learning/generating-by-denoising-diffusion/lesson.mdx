...
description: "How diffusion models create images: start from pure random static and remove noise step by step until a picture emerges, and how a text prompt steers it."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
