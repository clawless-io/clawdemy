---
title: "What deep learning adds, in brief"
description: "Orientation for the deep learning track: what deep adds, why it took off in 2012, the XOR depth proof, the four problem shapes ahead, prerequisites and time."
