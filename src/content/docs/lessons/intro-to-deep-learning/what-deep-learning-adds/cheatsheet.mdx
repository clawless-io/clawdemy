---
title: "Cheatsheet: What deep learning adds"
description: One-page reference. What "deep" means, why it waited decades, the 2012 depth+data+compute moment, why depth helps (XOR), the track map, what deep learning is not, pitfalls, and vocabulary.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
