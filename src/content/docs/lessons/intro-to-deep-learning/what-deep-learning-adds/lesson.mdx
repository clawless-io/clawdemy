---
title: "Lesson: What deep learning adds"
description: "You already know what a neural network is. This opening lesson of the deep learning track situates that knowledge in the bigger picture: what the word \"deep\" actually adds, why the same idea sat on the shelf for decades before suddenly working, and how depth, data, and compute came together around 2012 to start the modern era. It also previews the tour ahead and is honest about what deep learning is not."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
