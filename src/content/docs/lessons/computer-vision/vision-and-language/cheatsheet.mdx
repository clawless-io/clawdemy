---
title: "Vision and language: cheatsheet"
description: "One-page reference on CLIP: the two-tower contrastive setup, zero-shot classification, retrieval, captioning, VQA, modern VLMs, and the economic frame."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
