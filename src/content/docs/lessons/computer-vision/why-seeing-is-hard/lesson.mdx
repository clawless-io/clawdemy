---
title: "Lesson: Why seeing is hard for machines"
description: You recognize a friend in a blurry crowd photo without thinking. A computer, handed the same photo, sees only a grid of numbers with no "friend" anywhere inside. This lesson is about that gap, the semantic gap, why the same object produces wildly different pixels, why hand-written rules collapse, and the data-driven shift that makes modern computer vision work.
artifact: lesson
sidebar:
  order: 2
  label: Lesson
