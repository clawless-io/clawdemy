---
title: "Cheatsheet: Video understanding"
description: One-page reference. Video tensor, sampling, the architecture ladder (single-frame to video transformers), param-cost comparison.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
