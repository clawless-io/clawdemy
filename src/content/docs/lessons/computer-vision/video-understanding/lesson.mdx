...
description: "How vision systems add the time dimension to video: single-frame baseline, late and early fusion, 3D convolutions, two-stream networks, and video transformers."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
