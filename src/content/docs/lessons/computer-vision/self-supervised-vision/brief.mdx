---
title: "Self-supervised vision, in brief"
description: "An overview of self-supervised vision: why labels are scarce, the pretext-to-contrastive-to-masked-modeling arc, and the pre-train-then-transfer workflow."
