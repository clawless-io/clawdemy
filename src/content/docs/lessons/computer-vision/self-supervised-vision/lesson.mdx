---
title: "Self-supervised vision: learning without labels"
description: "How self-supervised learning trains vision models on unlabeled images: pretext tasks, contrastive methods (SimCLR, MoCo, BYOL), and masked image modeling."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
