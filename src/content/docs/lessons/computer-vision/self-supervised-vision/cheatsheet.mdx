---
title: "Cheatsheet: Self-supervised vision"
description: One-page reference. The core trick, pretext history, contrastive, masked image modeling, the transfer workflow.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
