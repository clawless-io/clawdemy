---
title: "Loss and optimization: cheatsheet"
description: "One-page reference for the training loop: SVM and softmax losses, regularization, the gradient descent update rule, learning rate, and mini-batch SGD."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
