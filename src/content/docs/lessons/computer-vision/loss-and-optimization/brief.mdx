---
title: "Loss and optimization: brief"
description: "A walkthrough of the training loop: the two standard losses, regularization, the gradient descent update rule, and mini-batch SGD, plus what to expect."
