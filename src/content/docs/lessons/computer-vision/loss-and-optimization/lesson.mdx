...
description: "How a classifier learns its weights: a loss function (SVM or softmax) turns predictions into one number, and gradient descent nudges W and b to drive it down."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
