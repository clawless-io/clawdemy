...
Let us run last lesson's scores through it. The toy 2-by-2 / 3-class classifier predicted scores of 0.8 for X, 0.3 for Y, and -0.4 for Z, and the correct class is X.
