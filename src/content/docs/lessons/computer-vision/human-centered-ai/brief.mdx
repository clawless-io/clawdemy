---
title: "Human-centered computer vision, in brief"
description: "What this lesson on deployed vision systems covers: the failure-mode catalog, bias as a measurable engineering property, and the trustworthiness gap."
