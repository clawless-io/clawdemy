---
title: "Computer vision among people, human-centered"
description: "How deployed vision systems fail (distribution shift, adversarial examples, bias, calibration), how to measure those failures, and how to engineer around them."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
