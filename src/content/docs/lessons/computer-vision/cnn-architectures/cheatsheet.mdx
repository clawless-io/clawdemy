---
title: "CNN architectures: cheatsheet"
description: "One-page reference for the four landmark CNN architectures: key ideas, layer counts, parameter counts, ImageNet results, and a training-at-scale glossary."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
