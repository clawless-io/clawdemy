---
title: "Sequence tools for vision: recurrence, attention"
description: "How recurrence (RNNs) and attention process sequences in vision: image captioning, video understanding, and the Vision Transformer (image as patches)."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
