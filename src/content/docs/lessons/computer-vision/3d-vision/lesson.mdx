...
description: "How vision systems recover 3D structure from 2D images: depth cues (stereo, monocular, motion), 3D representations, and methods from monocular depth to NeRF."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
