...
<ReadAlongDim
  src="https://audio.clawdemy.org/lessons/gans-and-vaes-lesson.mp3"
  slug="gans-and-vaes"
...
2. A **KL-divergence regularizer** that pushes the encoder's per-image distribution toward the standard normal prior. This is what keeps the latent space "well-organized": every point in the latent space has to correspond to *some* plausible image, not just the exact training images.
