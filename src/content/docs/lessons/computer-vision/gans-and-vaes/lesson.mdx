...
description: "How VAEs and GANs generate new images: the discriminative vs generative split, the reparameterization trick worked by hand, and the smooth-vs-sharp trade-off."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
