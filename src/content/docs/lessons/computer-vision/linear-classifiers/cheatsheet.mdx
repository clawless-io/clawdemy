---
title: "Cheatsheet: Linear classifiers"
description: One-page reference. The score function, shapes, what W is, the bias trick, the geometric view, the multi-modal limit.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
