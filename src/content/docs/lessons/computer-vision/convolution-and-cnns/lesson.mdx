...
description: "Why fully-connected layers fail on images, and how convolution fixes it: a small learned filter slides across the input, worked by hand on a vertical edge."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
