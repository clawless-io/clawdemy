---
title: "Convolution and CNNs: brief"
description: "Overview of the convolution lesson: the conv operation, weight sharing, output-size and parameter formulas, plus prerequisites, math level, and time needed."
