---
title: "World modeling: cheatsheet"
description: "One-page world modeling reference: reactive vs predictive vision, the three-piece architecture, pixel vs latent prediction, landmark models, and pitfalls."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
