---
title: "World modeling: brief"
description: "What to expect from the world modeling lesson: the reactive-vs-predictive split, the pixel-vs-latent trade-off, landmark architectures, and prerequisites."
