---
title: "Cheatsheet: Diffusion models"
description: One-page reference. Two-direction setup, training, inference, the three-way trade-off, latent diffusion, text-to-image.
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
