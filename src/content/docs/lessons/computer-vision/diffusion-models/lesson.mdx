...
description: "How diffusion models generate images: corrupt training data with noise, train a network to reverse it, then denoise from scratch into a new image."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
