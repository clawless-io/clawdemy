---
title: "Diffusion models: brief"
description: "What the diffusion lesson covers: the two-direction noising setup, the MSE training objective, inference speed-ups, and text-to-image conditioning."
