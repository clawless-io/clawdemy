---
title: "Detection, segmentation: cheatsheet"
description: "One-page reference for vision tasks beyond classification: detection families and IoU, segmentation types and architectures, and visualization methods."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
