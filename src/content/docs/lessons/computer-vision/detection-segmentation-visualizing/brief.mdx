---
title: "Detection, segmentation, visualization: brief"
description: "A roadmap to going beyond image classification: what detection, segmentation, and visualization add, the IoU metric, prerequisites, and time and difficulty."
