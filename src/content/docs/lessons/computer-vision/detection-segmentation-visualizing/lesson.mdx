---
title: "Detection, segmentation, seeing inside the net"
description: "Go beyond classification: detection finds what and where (R-CNN, YOLO, IoU), segmentation labels every pixel, and saliency or Grad-CAM reveal what networks see."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
