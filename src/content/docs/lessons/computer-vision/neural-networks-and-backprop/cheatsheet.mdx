---
title: "Neural networks and backprop: cheatsheet"
description: "One-page reference for the two-layer neural network: the ReLU equations, what the hidden layer learns, backprop in three lines, and the full training loop."
sidebar:
  order: 5
  label: Cheatsheet
artifact: cheatsheet
