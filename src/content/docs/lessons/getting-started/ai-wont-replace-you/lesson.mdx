...
<LessonStar slug="ai-wont-replace-you" />

<ReadAlongLesson src="https://audio.clawdemy.org/lessons/ai-wont-replace-you-lesson.mp3"
  slug="ai-wont-replace-you" approxMinutes={12} />
...
If you want to hear this from someone with more skin in the AI game than anyone, here it is. Jensen Huang, the founder and CEO of Nvidia (the company that builds the hardware AI runs on), made the case in plain language at Stanford this April:
