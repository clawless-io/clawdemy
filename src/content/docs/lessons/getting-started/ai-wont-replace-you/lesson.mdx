...
description: "AI exposes whether you can think when mechanical work falls away. Learn the amplifier rule and your human delta: judgment, context, taste, trust."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
...
<ReadAlongDim
  src="https://audio.clawdemy.org/lessons/ai-wont-replace-you-lesson.mp3"
