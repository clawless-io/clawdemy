---
title: "Clawless Computer memory system: cheatsheet"
description: "Quick reference for the Clawless Computer memory system: history versus memory, the four tiers, the panel controls, agent sharing, privacy, and key settings."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
...
| --- | --- | --- | --- |
| Pinned | Facts you explicitly told [Clawless Computer](https://clawless.ai) to always remember | You Pin them | In every prompt; hard size cap around 2,200 characters total |
...
All agents on a single Clawless Computer install share one memory pool. Tell the Assistant your name, the Writer knows it. The Researcher knows it.
...
| Question | Answer |
| --- | --- |
| Where do memories live? | On your computer, in a local Clawless Computer data file. Not on any Clawless Computer server. |
...
A later lesson covers Channels and integrations: how Clawless Computer reaches outside the chat (email, Slack, calendars). A later lesson covers CostGuard and the local-first privacy posture in depth: the cap that prevents a runaway BYOK spend, and the architectural reason your data does not pass through Clawless Computer. Everything else in the track assumes you have a working memory pool. That is what this lesson left you with.
