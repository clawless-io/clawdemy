...
description: "Quick reference for the Clawless memory system: history versus memory, the four tiers, the panel controls, agent sharing, privacy, and key settings."
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
