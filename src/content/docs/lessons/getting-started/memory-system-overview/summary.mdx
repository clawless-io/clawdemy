---
title: "Summary: How Clawless Computer remembers (and forgets)"
...
- **Tier 1, Pinned.** Facts you explicitly told Clawless Computer to always remember. Follow you across every conversation. The most load-bearing tier. Hard size cap (around 2,200 characters total) because Pinned content goes into every prompt and would otherwise silently slow and cost everything down. If you hit the cap, Clawless Computer tells you and asks you to consolidate.
...
- **Tier 4, Decayed.** The path to forgetting without deleting. If a memory has not been touched in a long time, it ages here automatically. Still exists, still visible in the panel, but Clawless Computer does not surface it in new conversations unless something current makes it look very relevant again. If you start working on an old project after a year, the relevant Decayed memories wake back up.
...
- **Sharing across agents.** All agents on a single Clawless Computer install share one memory pool by default. Tell the Assistant your name, the Writer knows it too. Right default because per-agent re-explaining would be almost as exhausting as per-conversation re-explaining. Per-agent isolation is on the roadmap.
- **Where memories live.** On your computer, in a local Clawless Computer data file. Not on any Clawless Computer server. If Clawless went out of business tomorrow, your memories would still be on your computer, readable by you.
...
- **The practical privacy rule.** If there is a fact you never want leaving your computer, do not save it as a memory. Anything you want kept strictly local belongs in your own notes, not in Clawless Computer memory.
