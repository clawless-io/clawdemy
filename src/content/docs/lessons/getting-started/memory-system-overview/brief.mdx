...
description: A tour of the memory system. The distinction between conversation history and memory, the four tiers (Pinned, Insights, General, Decayed), the three pathways memories get in, the Memory panel where you control them, and the privacy rule for what should and should not be saved.
