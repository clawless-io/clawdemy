---
title: "Lesson: How Clawless remembers (and forgets)"
description: A tour of the memory system. The four tiers, how memories get there, where to control what Clawless keeps, and why a memory that fades is different from a memory that gets deleted.
artifact: lesson
sidebar:
  order: 2
  label: Lesson
...
{/* COMPONENT PLACEHOLDER (Lead wires at promotion): <LessonStar slug="memory-system-overview" /> */}

{/* COMPONENT PLACEHOLDER (Lead wires at promotion after Phase 2 audio): <ReadAlongDim src="..." slug="memory-system-overview" cacheVersion="..." approxMinutes={11} /> */}
