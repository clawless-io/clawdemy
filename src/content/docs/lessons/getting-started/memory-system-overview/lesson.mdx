...
description: "How Clawless Computer remembers facts across conversations: the four memory tiers, where to control them, and why fading differs from deleting."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
