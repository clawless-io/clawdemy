---
title: "How Clawless Computer remembers (and forgets)"
description: "How Clawless Computer remembers facts across conversations: the four memory tiers, how memories get added, where to control them, and why fading differs from deleting."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
...
## What memory actually is in Clawless Computer
