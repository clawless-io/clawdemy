---
title: "Cheatsheet: CostGuard and where your data goes"
description: One-page reference. The CostGuard settings, what counts vs what does not, the visual cues, the data path, the three places your stuff lives, the four-party trust model, and what survives if Clawless goes away.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
