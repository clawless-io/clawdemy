...
description: "How Clawless Computer guards against runaway charges with CostGuard spending caps, and where your data goes: your computer, the AI provider, your computer."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
