---
title: "Lesson: CostGuard and where your data goes"
description: How Clawless protects you from runaway charges and what its local-first privacy posture actually means. The spending cap, the warn-vs-block dials, and a clear-eyed look at who sees what.
artifact: lesson
sidebar:
  order: 2
  label: Lesson
...
{/* COMPONENT PLACEHOLDER (Lead wires at promotion): <LessonStar slug="costguard-and-privacy-posture" /> */}

{/* COMPONENT PLACEHOLDER (Lead wires at promotion after Phase 2 audio): <ReadAlongDim src="..." slug="costguard-and-privacy-posture" cacheVersion="..." approxMinutes={12} /> */}
