...
description: "How Clawless Computer connects to AI providers. What an API key is, where yours lives, and the OAuth path that lets ChatGPT subscribers skip per-token charges."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
