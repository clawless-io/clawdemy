...
{/* COMPONENT PLACEHOLDER (Lead wires at promotion): <LessonStar slug="api-keys-and-provider-oauth" /> */}

{/* COMPONENT PLACEHOLDER (Lead wires at promotion after Phase 2 audio): <ReadAlongDim src="..." slug="api-keys-and-provider-oauth" cacheVersion="..." approxMinutes={10} /> */}
