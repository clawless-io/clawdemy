---
title: "Cheatsheet: API keys and the OAuth path"
description: One-page reference. What an API key is, the BYOK billing model, where keys live, the Codex OAuth path, three reasons a key turns red, and how to add another provider.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
