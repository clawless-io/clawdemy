...
description: "Send your first message in Clawless, find the model picker, switch models mid-conversation without losing your place, and reach models off the short list."
artifact: lesson
sidebar:
  order: 2
  label: Lesson
