---
title: "Lesson: Your first conversation and picking a model"
description: The first hands-on lesson. Send your first message in Clawless, find the model picker, and switch models mid-conversation without losing your place.
artifact: lesson
sidebar:
  order: 2
  label: Lesson
...
{/* COMPONENT PLACEHOLDER (Lead wires at promotion): <LessonStar slug="first-conversation-and-model-selector" /> */}

{/* COMPONENT PLACEHOLDER (Lead wires at promotion after Phase 2 audio): <ReadAlongDim src="..." slug="first-conversation-and-model-selector" cacheVersion="..." approxMinutes={11} /> */}
