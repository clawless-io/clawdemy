...
Clawless then uses that model even if it is not on the visible short list.
...
1. **Open Clawless.** Confirm you are on the Assistant agent (the default avatar at the top of the left rail). If you are elsewhere, click Assistant.
...
<Flashcard question="What are the four screen zones of Clawless?">
