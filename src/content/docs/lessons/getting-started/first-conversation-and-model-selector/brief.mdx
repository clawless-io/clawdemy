...
description: "Overview of the first hands-on Clawless Computer lesson: the four screen zones, the model picker, mid-conversation switching, and what you need before you start."
...
learning_outcomes:
  - Identify the four screen zones of Clawless Computer (agent rail, chat, dock row, navigation rail) and the role each plays
