...
description: The first hands-on Clawless lesson. Send your first message, find the model picker in the dock row, switch models mid-conversation without losing your place, and use the provider-prefixed pattern to reach off-list models. The capability the rest of the track sits on.
