---
title: "Cheatsheet: Your first conversation and picking a model"
description: One-page reference. The four screen zones, the model picker map, switching rules, per-agent behavior, and the cost meter.
artifact: cheatsheet
sidebar:
  order: 5
  label: Cheatsheet
