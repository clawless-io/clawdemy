...
export const THEMES: Record<ThemeKey, ThemeMeta> = {
	...
	product: {
		key: 'product',
		label: 'For Clawless Computer users',
		tagline: 'Get hands-on with Clawless Computer itself.',
		accent: '#475569',
		order: 6,
	},
};
...
export const TRACKS: Track[] = [
	{
		...
		title: 'Getting Started with Clawless Computer',
	...
	// --- Planned (not yet built; rendered only where status is surfaced) ----
	{
		...
		blurb: 'Copy-pasteable recipes for real tasks, runnable in Clawless Computer.',
		theme: 'product',
		level: 'Beginner',
		lessons: 0,
		status: 'planned',
	...
	},
	{
		...
		blurb: 'Skills, tools, channels, and cron: the Clawless Computer extension layer.',
		theme: 'product',
		level: 'Intermediate',
		lessons: 0,
		status: 'planned',
